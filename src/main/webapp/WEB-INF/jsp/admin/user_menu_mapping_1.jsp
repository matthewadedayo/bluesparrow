<%-- 
    Document   : user_menu_mapping
    Created on : Feb 12, 2019, Feb 12, 2019 2:24:47 PM
    Author     : OLAWALE
--%>
...
<%!
    public String getStatus(Object id, Object status)
    {
        ...
        {
            return "<a href=\"#\" title=\""+id+"\" class=\"btn-status btn-success add_priviledge_child\">Enabled</a><input type=\"hidden\" value=\"" + status + "\" />";
        }
        else
        {
            return "<a href=\"#\" title=\""+id+"\" class=\"btn-status btn-danger add_priviledge_child\">Disabled</a><input type=\"hidden\" value=\"" + status + "\" />";
        }
...
//    ArrayList<Object[]> menuMasterObjectList = (ArrayList<Object[]>) request.getAttribute("menuMasterObjectList");
      ...
      ArrayList<Object[]> allMenuMasterObjectList = (ArrayList<Object[]>) request.getAttribute("allMenuMasterObjectList");
      ArrayList<Object[]> allMenuChildObjectList = (ArrayList<Object[]>) request.getAttribute("allMenuChildObjectList");
      Object roleType = request.getAttribute("roleType");
//      Object menuId = request.getAttribute("menuId");
   
      
      Map<String, String> menuMasterMap = new HashMap<String, String>();
      int next = 0;
      while(next < allMenuMasterObjectList.size())
      {
          System.out.println("tp: " + allMenuMasterObjectList.get(next)[1].toString());
          menuMasterMap.put(allMenuMasterObjectList.get(next)[0].toString(), allMenuMasterObjectList.get(next)[1].toString());
          next++;
      }
      ...
      userType.put("CONTENT-PROVIDER", "CONTENT-PROVIDER");
      userType.put("REVIEWER", "REVIEWER");
      userType.put("PUBLISHER", "PUBLISHER");
...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>BlueSparrow | Grant Privilege</title>
		<meta name="description" content="Grant Privilege">
...
<!--							<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="javascript:;" class="m-menu__link m-menu__toggle"><i class="m-menu__link-icon flaticon-share"></i><span class="m-menu__link-text">Content</span><i
							...
							<li class="m-menu__item  m-menu__item--submenu m-menu__item--open m-menu__item--expanded" aria-haspopup="true" m-menu-submenu-toggle="hover"><<a href="javascript:;" class="m-menu__link m-menu__toggle"><i class="m-menu__link-icon flaticon-users"></i><span class="m-menu__link-text">User</span><i
									 class="m-menu__ver-arrow la la-angle-right"></i></a>
								<div class="m-menu__submenu "><span class="m-menu__arrow"></span>
									<ul class="m-menu__subnav">
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="" class="m-nav__link">
											<span class="m-nav__link-text">Grant Priviledges</span>
										</a>
									</li>
									<li class="m-nav__separator">-</li>
								</ul>
					...
					<div class="m-content">
								...
								<div class="m-portlet m-portlet--tab m-portlet--center">
									...
									<!--begin::Form-->
									<form class="m-form m-form--fit m-form--label-align-right" action="get_role_menu_child_map.htm">
										<div class="m-portlet__body">
											<div class="form-group m-form__group">
												<label class="col-lg-12">
												<select class="form-control m-input m-input--square" id="roleType" name="roleType" required>
                                                                                                    <%
                                                                                                        if(roleType==null)
                                                                                                        {
                                                                                                    %>
													<option disabled selected value="">Select User*</option>
                                                                                                        ...
                                                                                                        else
                                                                                                        {
                                                                                                            ...
                                                                                                            {
                                                                                                                if(userType.containsKey(roleType))
                                                                                                                {
                                                                                                                    %>
                                                                                                                    <option value="<%=roleType%>"><%=userType.get(roleType)%></option>
                                                                                                                    <%
                                                                                                                    break;
                                                                                                                }
                                                                                                            ...
                                                                                                            Set<String> keys = userType.keySet();
                                                                                                            Iterator<String> itr = keys.iterator();
                                                                                                            int i=0;
                                                                                                            while(itr.hasNext())
                                                                                                            {
                                                                                                                String key = itr.next();
                                                                                                                if(!key.equals(userObject[i]) && !key.equals(roleType))
                                                                                                                {
                                                                                                                    System.out.println(key);
                                                                                                                     %>
                                                                                                                    <option value="<%=key%>"><%=userType.get(key)%></option>
                                                                                                                    <%
                                                                                                                    ++i;
                                                                                                                }
                                                                                                            }
								...
								<table class="m-datatable" id="html_table" width="100%">
									<thead>
										<tr>
											...
											<th class="text-center" title="Field #2" data-field="role">Role</th>
											<!--<th title="Field #3" data-field="submenu">Submenu</th>-->
											<th class="text-center" title="Field #4" data-field="menu">Menu</th>
                                                                                        <th class="text-center" title="Field #3" data-field="submenu">Submenu</th>
											<th class="text-center" title="Field #5" data-field="status">Status</th>	
<!--											<th title="Field #1" data-field="ID">ID</th>
											<th title="Field #2" data-field="menu">Menu</th>
											<th title="Field #3" data-field="submenu">Submenu</th>
											<th title="Field #4" data-field="url">Url</th>
											<th title="Field #5" data-field="status">Status</th>										-->
										</tr>
									</thead>
									<tbody>
                                                                            <%
                                                                                                        if(allMenuChildObjectList!=null)
                                                                                                        {
                                                                                    ...
                                                                                    %>
										<tr>
                                                                                    <td><center><%= allMenuChildObjectList.get(count)[0]%></center></td>
                                                                                    <td><center><%= roleType %></center></td>
                                                                                    <td><center><%= allMenuChildObjectList.get(count)[1]%></center></td>
                                                                                    <td><center><%= allMenuChildObjectList.get(count)[2]%></center></td>
                                                                                    ...
                                                                                    <center>
                                                                                        <!--<label class="m-checkbox m-checkbox--state-primary">-->
                                                                                                ...
                                                                                                <%=getStatus(allMenuChildObjectList.get(count)[0], allMenuChildObjectList.get(count)[5])%>
                                                                                                <!--<span></span>-->
                                                                                        <!--</label>-->
                                                                                    </center><input class="menu_hidden" type="hidden" value="<%= allMenuChildObjectList.get(count)[6]%>" />
                                                                                    </td>
										</tr>
                                                                                <%
                                                                                    }
