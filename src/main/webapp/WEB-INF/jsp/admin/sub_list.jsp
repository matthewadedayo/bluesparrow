<%-- 
    Document   : sub_list
    Created on : May 2, 2019, May 2, 2019 9:03:11 AM
    Author     : OLAWALE
--%>
...
//      ArrayList<Object[]> userMasterObjectList = (ArrayList<Object[]>) request.getAttribute("userMasterObjectList");
        ArrayList<Object[]> allSubscriptionMasterObjectList = (ArrayList<Object[]>) request.getAttribute("allSubscriptionMasterObjectList");
//      ArrayList<Object[]> allBannerMasterObjectList = (ArrayList<Object[]>) request.getAttribute("allBannerMasterObjectList");
...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>BlueSparrow | Subscription Plan</title>
		<meta name="description" content="List Menu">
					...
					<div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-dark m-aside-menu--submenu-skin-dark " m-menu-vertical="1" m-menu-scrollable="1" m-menu-dropdown-timeout="500" style="position: relative;">
						<ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
							...
							<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="javascript:;" class="m-menu__link m-menu__toggle"><i class="m-menu__link-icon flaticon-interface-1"></i><span class="m-menu__link-text">Subscriber</span><i
								...
								<div class="m-menu__submenu "><span class="m-menu__arrow"></span>
									<ul class="m-menu__subnav">
										<li class="m-menu__item " aria-haspopup="true"><a href="subscriber_manage.html" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Manage Subcriber</span></a></li>
										<li class="m-menu__item " aria-haspopup="true"><a href="subscriber_blacklist" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Blacklist Subcriber</span></a></li>
									</ul>
								</div>
							</li>
							<li class="m-menu__item  m-menu__item--submenu m-menu__item--open m-menu__item--expanded" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="javascript:;" class="m-menu__link m-menu__toggle"><i class="m-menu__link-icon flaticon-interface-6"></i><span class="m-menu__link-text">Billing</span><i
									 class="m-menu__ver-arrow la la-angle-right"></i></a>
								<div class="m-menu__submenu "><span class="m-menu__arrow"></span>
									<ul class="m-menu__subnav">
										<li class="m-menu__item m-menu__item--active" aria-haspopup="true"><a href="#" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Subscription Plan</span></a></li>
									</ul>
								</div>
							</li>
							...
							<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="#" class="m-menu__link m-menu__toggle"><i class="m-menu__link-icon flaticon-interface-9"></i><span class="m-menu__link-text">FAQS</span><i class="m-menu__ver-arrow la la-angle-right"></i></a>
                                      <div class="m-menu__submenu "><span class="m-menu__arrow"></span>
												<ul class="m-menu__subnav">
													<li class="m-menu__item" aria-haspopup="true"><a href="faq_list.html" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Faqs</span></a></li>
													 <li class="m-menu__item " aria-haspopup="true"><a href="faq_add.html" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Add Faqs</span></a></li>
												</ul>
											</div>							
							            </li>
							<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="#" class="m-menu__link m-menu__toggle"><i class="m-menu__link-icon flaticon-piggy-bank"></i><span class="m-menu__link-text">Support</span><i class="m-menu__ver-arrow la la-angle-right"></i></a>
							 <div class="m-menu__submenu "><span class="m-menu__arrow"></span>
												<ul class="m-menu__subnav">
													<li class="m-menu__item " aria-haspopup="true"><a href="inbox.html" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Inbox</span></a></li>
													 <li class="m-menu__item " aria-haspopup="true"><a href="new_email.html" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">New Email</span></a></li>
													 <li class="m-menu__item " aria-haspopup="true"><a href="history.html" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">History</span></a></li> 
												</ul>
											</div>	
							          </li>
							<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="#" class="m-menu__link m-menu__toggle"><i class="m-menu__link-icon flaticon-exclamation"></i><span class="m-menu__link-text">Feedback Forum</span><i class="m-menu__ver-arrow la la-angle-right"></i></a>
                              <div class="m-menu__submenu "><span class="m-menu__arrow"></span>
												<ul class="m-menu__subnav">
													<li class="m-menu__item " aria-haspopup="true"><a href="forum_list.html" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Forums</span></a></li>
													 <li class="m-menu__item " aria-haspopup="true"><a href="forum_new.html" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">New Forums</span></a></li>
												</ul>
											</div>	
							</li>
						</ul>
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title">Subscription Plans</h3>
						...
						<div class="m-portlet m-portlet--mobile">
							...
							<div class="m-portlet__body">
												...
												<div class="col-md-4">
													<div class="m-form__group m-form__group--inline">
														<div class="m-form__label">
															<label class="m-label m-label--single">Subscription Plan:</label>
														</div>
													...
													<div class="m-form__group m-form__group--inline">
														...
														<div class="m-form__control">
															<select class="form-control m-bootstrap-select" id="m_form_type">
																...
																<option value="1">BlueSparrow</option>
																<option value="2">PlayCode</option>
																<option value="3">AudeBook</option>
																<option value="2">BoxAfrica</option>
																<option value="3">Musik365</option>
															</select>
														</div>
													</div>
													<div class="d-md-none m--margin-bottom-10"></div>
								...
								<div class="m-invoice__body m-invoice__body--centered">
									...
									<thead>
										<tr>
										    <th title="Field #1" data-field="Subcription Plan">Subscription Plan</th>
											<th title="Field #2" data-field="Package">Package</th>
											<th title="Field #3" data-field="Portal">Portal</th>
											<th title="Field #4" data-field="Price">Price</th>
											<th title="Field #5" data-field="Action">Action</th>
										</tr>
									</thead>
									<tbody>	
                                                                            <%
                                  
                                    for(int count=0; count<allSubscriptionMasterObjectList.size();++count)
                                    {
                                  
                                  %>                
                                                                            <tr>                               
										    <td><%=allSubscriptionMasterObjectList.get(count)[1]%></td>
											<td><%=allSubscriptionMasterObjectList.get(count)[3]%></td>
											<td><%=allSubscriptionMasterObjectList.get(count)[2]%></td>
											<td><%=allSubscriptionMasterObjectList.get(count)[5]%><%=allSubscriptionMasterObjectList.get(count)[4]%></td>
											<td><a href="edit_sub.htm?id=<%=allSubscriptionMasterObjectList.get(count)[0]%>" class="ico edit">Edit</a> | <a href="#">Publish</a></td>
										</tr>
                                                                                 <%
                                    }
                                        %>
<!--										<tr>
											...
											<td>Audebook</td>
											<td>$400</td>
											<td><a href="#">Edit</a> | <a href="#">Publish</a></td>
										</tr>
										<tr>
											<td>Basic</td>
											<td>Daily</td>
