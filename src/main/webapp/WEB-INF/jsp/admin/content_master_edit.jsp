<%-- 
    ...
    Created on : Nov 12, 2018, Nov 12, 2018 9:52:47 PM
    Author     : OLAWALE
--%>
...
//    ArrayList<Object[]> menuMasterObjectList = (ArrayList<Object[]>) request.getAttribute("menuMasterObjectList");
      ...
      System.out.println("con: " + contentMasterObject);
...
//      Object userId = (Object)request.getAttribute("user_id");
      ...
      storageType.put("LOCAL", "Local");
      storageType.put("REMOTE", "Remote");
...
<!--							<div>
					...
					<div class="m-content">
											...
											<div class="m-wizard__head">
												...
												<!--begin: Form Wizard Progress -->
													...
													<div class="m--space-10"></div>
														<div class="progress">
															<div class="progress-bar bg-success" role="progressbar" style="width: 50%" aria-valuenow="50" aria-valuemin="" aria-valuemax="100"></div>
						...
						-->
									...
									<!--begin::Form-->
                                                                                    <form class="m-form m-form--fit m-form--label-align-right" action="save_content_master_details.htm?id=<%=contentMasterObject[0]%>" enctype="multipart/form-data" method="post">
																...
																<div class="form-group m-form__group row">
																	...
																	<div class="col-xl-9 col-lg-9">
                                                                                                                                            <input type="text" class="form-control m-input" placeholder="Title" value="<%=contentMasterObject[10] %>" name="type" id="" disabled>
                                                                                                                                            <input type="hidden" name="cont_mst_type" value="<%=contentMasterObject[10] %>" />
																...
																<div class="form-group m-form__group row">
																	...
																	<div class="col-xl-9 col-lg-9">
                                                                                                                                            <input type="text" class="form-control m-input" placeholder="" value="<%=contentMasterObject[9] %>" name="" id="" disabled>
                                                                                                                                            <input type="hidden" name="cont_cat_mst_title" value="<%=contentMasterObject[9] %>" />
<!--																		<select id="cont_cat" name="cont_cat_mst_id" class="form-control m-input" required>
									...
									<div class="form-group m-form__group row">
										...
										<div class="col-xl-9 col-lg-9">
                                                                                    <input type="text" class="form-control m-input" placeholder="" value="<%=contentMasterObject[11] %>" name="" id="" disabled>
                                                                                    <input type="hidden" name="cont_sub_cat_mst_title" value="<%=contentMasterObject[11] %>" />
<!--											<select class="form-control m-input"  id="cont_sub_cat" name="cont_sub_cat_mst_id">
																...
																<div class="form-group m-form__group row">
																	...
																	<div class="col-xl-9 col-lg-9">
																		<input  id="title_size" type="text" class="form-control m-input" placeholder="Title" value="<%=contentMasterObject[1] %>" name="title" maxlength="50" required>
																		<span  class="m-form__help">Please enter your content title (<span id="tx">50</span>)</span>
																	</div>
																</div>
																...
																<div class="form-group m-form__group row">
																	...
																	<div class="col-xl-9 col-lg-9">
                                                                                                                                            <textarea id="desc_size" class="form-control m-input" id="desc" placeholder="Brief Description" rows="3" name="desc" maxlength="512" required><%=contentMasterObject[2] %></textarea>
																		<span class="m-form__help">Brief Description (<span id="dx">512</span>)</span>
																	</div>
																</div>
																...
																<div class="form-group m-form__group row">
																	...
																	<div class="col-xl-9 col-lg-9">
																		<select class="form-control m-input" name="store_type"  id="store_type" required>
                                                                                                                                                    <%
                                                                                                                                                        for(int j=0; j<storageType.size(); ++j)
                                                                                                                                                        {
                                                                                                                                                            if(storageType.containsKey(contentMasterObject[7]))
                                                                                                                                                            {
                                                                                                                                                                %>
                                                                                                                                                                <option value="<%=contentMasterObject[7]%>"><%=storageType.get(contentMasterObject[7])%></option>
                                                                                                                                                                <%
                                                                                                                                                                break;
                                                                                                                                                            }
                                                                                                                                                        ...
                                                                                                                                                        Set<String> keys2 = storageType.keySet();
                                                                                                                                                        Iterator<String> itr2 = keys2.iterator();
                                                                                                                                                        int p=0;
                                                                                                                                                        while(itr2.hasNext())
                                                                                                                                                        {
                                                                                                                                                            String key = itr2.next();
                                                                                                                                                            if(!key.equals(contentMasterObject[p]) && !key.equals(contentMasterObject[7]))
                                                                                                                                                            {
                                                                                                                                                                System.out.println(key);
                                                                                                                                                                 %>
                                                                                                                                                                <option value="<%=key%>"><%=storageType.get(key)%></option>
                                                                                                                                                                <%
                                                                                                                                                                ++p;
                                                                                                                                                            }
                                                                                                                                                        }
...
<!--																			<option disabled selected value="">
																		...
																		<div style="display: <%= contentMasterObject[7].equals("REMOTE")?"none": ""%>" class="file_load">
                                                                                                                                                    <input class="form-control m-input load" id = "small_thumb" type = "file" <%if(contentMasterObject[7].equals("LOCAL")) { %> required <% } %> name="small_thumb"  />
																			<span class="m-form__help">
                                                                                                                                                            Thumbnail Small <i id="sm_th">(200X200)</i>
																			</span>
																		</div>
                                                                                                                                            
                                                                                                                                                <div style="display: <%= contentMasterObject[7].equals("LOCAL")?"none": ""%>" class="url_text">
                                                                                                                                                    <input class="form-control m-input text" type="text" value="<%=contentMasterObject[4]%>" maxlength="264"  name="small_thumb_url" id="small_thumb_url" required <%if(contentMasterObject[7].equals("REMOTE")) { %> required <% } %> autocomplete="off" placeholder="Thumbnail Small url*" />
<!--																			<span class="m-form__help">
																		...
																		<div style="display: <%= contentMasterObject[7].equals("REMOTE")?"none": ""%>" class="file_load">
																			<input class="form-control m-input load" id = "middle_thumb" type = "file" <%if(contentMasterObject[7].equals("LOCAL")) { %> required <% } %> name="middle_thumb"  />
																			<span class="m-form__help">
                                                                                                                                                ...
                                                                                                                                                <div style="display: <%= contentMasterObject[7].equals("LOCAL")?"none": ""%>" class="url_text">
																			<input class="form-control m-input text" type="text" value="<%=contentMasterObject[5]%>" maxlength="264" name="middle_thumb_url" id="middle_thumb_url" required <%if(contentMasterObject[7].equals("REMOTE")) { %> required <% } %> autocomplete="off" placeholder="Thumbnail Middle url*" />
<!--																			<span class="m-form__help">
																		...
																		<div style="display: <%= contentMasterObject[7].equals("REMOTE")?"none": ""%>" class="file_load">
																			<input class="form-control m-input load" id = "large_thumb" type = "file" <%if(contentMasterObject[7].equals("LOCAL")) { %> required <% } %> name="large_thumb"  />
																			<span class="m-form__help">
                                                                                                                                            ...
                                                                                                                                            <div style="display: <%= contentMasterObject[7].equals("LOCAL")?"none": ""%>" class="url_text">
																			<input class="form-control m-input text" type="text" value="<%=contentMasterObject[6]%>" maxlength="264" name="large_thumb_url" id="large_thumb_url" required <%if(contentMasterObject[7].equals("REMOTE")) { %> required <% } %> autocomplete="off" placeholder="Thumbnail Large url*" />
<!--																			<span class="m-form__help">
													...
													<div class="m-portlet__foot m-portlet__foot--fit m--margin-top-40">
														<div class="m-form__actions">
															<div class="row">
																<div class="col-lg-6 m--align-left">	</div>
																<div class="col-lg-6 m--align-right">
                                                                                                                                        <input type="hidden" name="small" value="<%=contentMasterObject[4]%>" />
                                                                                                                                        <input type="hidden" name="mid" value="<%=contentMasterObject[5]%>" />
                                                                                                                                        <input type="hidden" name="large" value="<%=contentMasterObject[6]%>" />
                                                                                                                                        <input type="submit" class="btn btn-success m-btn m-btn--custom m-btn--icon" value="Save & Continue" >
<!--																	<a href="#" class="btn btn-success m-btn m-btn--custom m-btn--icon" >
																		<span>
																			<span>Save & Continue</span>
                                                                                                                                                        <span><input type="submit" value="Save & Continue"></span>
