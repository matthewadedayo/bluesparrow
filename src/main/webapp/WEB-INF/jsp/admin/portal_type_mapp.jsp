...
//    }
    ...
    public String getStatus(Object id, Object status)
    {
        if(status.toString().equals("1"))
        {
            return "<a href=\"#\" title=\""+id+"\" class=\"btn-status btn-success edit_portal_type_map_status\">Enabled</a><input type=\"hidden\" value=\"" + status + "\" />";
        }
        else
        {
            return "<a href=\"#\" title=\""+id+"\" class=\"btn-status btn-danger edit_portal_type_map_status\">Disabled</a><input type=\"hidden\" value=\"" + status + "\" />";
        }
...
//    ArrayList<Object[]> menuMasterObjectList = (ArrayList<Object[]>) request.getAttribute("menuMasterObjectList");
      ...
      ArrayList<Object[]> allContentTypeMasterObjectList2 = (ArrayList<Object[]>) request.getAttribute("allContentTypeMasterObjectList2");
      
//      ArrayList<Object[]> allTypePortalMappingObjectList = (ArrayList<Object[]>) request.getAttribute("allTypePortalMappingObjectList");
      
      String contentPortalMasterId = (String) request.getAttribute("contentPortalMasterId");
      Object contentTypePortalMappingStatus = (Object) request.getAttribute("contentTypePortalMappingStatus");
      ...
      int move = 0;
//      System.out.println("olkkk1: " + allContentTypeMasterObjectList.size());
//      System.out.println("olkkk: " + allContentTypeMasterObjectList);
      if(allContentTypeMasterObjectList2!=null)
      {
        while(move < allContentTypeMasterObjectList2.size())
        {
            System.out.println("tp: " + allContentTypeMasterObjectList2.get(move)[1].toString());
            type.put(allContentTypeMasterObjectList2.get(move)[0].toString(), allContentTypeMasterObjectList2.get(move)[1].toString());
            move++;
        }
      }
      else
      {
          allContentTypeMasterObjectList2 = allContentTypeMasterObjectList;
      }
      System.out.println("olkkk2");
						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="" class="m-nav__link">
											<span class="m-nav__link-text">Content Type Mapping</span>
										</a>
									</li>
									<li class="m-nav__separator">-</li>
								</ul>
					...
					<div class="m-content">
							<!--begin::Portlet-->
								<div class="m-portlet m-portlet--tab m-portlet--center">
									...
									<!--begin::Form-->
									<form class="m-form m-form--fit m-form--label-align-right" action="get_content_type_portal_mpp.htm" method="post">
...
{
    %>
						<div id="table_cont" class="m-portlet m-portlet--mobile">
							<div class="m-portlet__head">
								<div class="m-portlet__head-caption">
								<div class="m-portlet__head-title">
										<h3 class="m-portlet__head-text">
								...
								<div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
									<div class="row align-items-center">
										<div class="col-xl-8 order-2 order-xl-1">
                                                                                    <form id="load_by_title_frm" action="get_porta_type_map_by_typ_stat.htm" method="get">
                                                                                        <input type="hidden" name="content_portal_master" value="<%=contentPortalMasterId%>" />
													...
													<div class="m-form__group m-form__group--inline">
														...
														<div class="m-form__control">
															<select class="form-control m-bootstrap-select sch_by" id="m_form_status" name="status" >
																<%
                                                                                                                                System.out.println("hhh: " +contentTypePortalMappingStatus);
                                                                                                                                    if(contentTypePortalMappingStatus==null)
                                                                                                                                    {
                                                                                                                                        %>
                                                                                                                                        <!--<option value="100">All</option>-->
                                                                                                                                        <%
                                                                                                                                        for(int count=-1; count<status.size()-1; ++count)
                                                                                                                                        {
                                                                                                                                    ...
                                                                                                                                    
                                                                                                                                    {
                                                                                                                                        ...
                                                                                                                                        {
                                                                                                                                            if(status.containsKey(contentTypePortalMappingStatus.toString()))
                                                                                                                                            {
                                                                                                                                                %>
                                                                                                                                                <option value="<%=contentTypePortalMappingStatus%>"><%=status.get(contentTypePortalMappingStatus.toString())%></option>
                                                                                                                                                <%
                                                                                                                                                break;
                                                                                                                                            }
...
//                                                                                                                                            
                                                                                                                                            if(!key.equals(contentTypePortalMappingStatus.toString()))
                                                                                                                                            {
								...
								<table class="m-datatable" id="html_table" width="100%">
									<thead>
										<tr>
											...
											<th class="text-center" title="Field #2" data-field="content_portal">Content Type</th>
											<th class="text-center" title="Field #3" data-field="content_cat">Portal</th>
											<!--<th title="Field #4" data-field="sub_content_cat">Sub Content Category</th>-->
									...
									<tbody>
                                                                                ...
                                                                                <%
                                                                                                        if(allContentTypeMasterObjectList!=null)
                                                                                                        {
                                                                                    ...
                                                                                    %>
										<tr>
                                                                                    <td><center><%= allContentTypeMasterObjectList.get(count)[0]%></center></td>
                                                                                    <td><center><%= allContentTypeMasterObjectList.get(count)[1]%></center></td>
                                                                                    ...
                                                                                    <center>
                                                                                            ...
                                                                                            <%=getStatus(allContentTypeMasterObjectList.get(count)[0], allContentTypeMasterObjectList.get(count)[3])%>
                                                                                            <!--<a href="#" title="id" class="btn-status btn-primary edit_portal_type_map_status">Active</a><input type="hidden" value="<%= allContentTypeMasterObjectList.get(count)[3]%>" />-->
