			...
			<div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-body">
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-content">
						...
						<div class="m-portlet">
							<!--begin::Form-->
                                                        <form action="add_faqs_master.htm" method="post" class="m-form m-form--fit m-form--label-align-right">
...
<!--											<label for="exampleInputEmail1">
											...
											<div class="m-form__group form-group">
																...
																<div id="portal_list" class="m-checkbox-list">
                                                                                                                                    <%
																	...
																	<label class="m-checkbox">
                                                                                                                                            <input class="option_portal" type="checkbox" name="portal" value="<%= allContentPortalMasterObjectList.get(count)[0] %>">
										...
										<div class="col-lg-9 col-md-9 col-sm-12">
											<label for="exampleInputEmail1">
												Faq Title
                                                                                    ...
                                                                                    <input type="text" name="qtitle" class="form-control m-input m-input--square" required id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Your Question?">
											<span class="m-form__help">
												We are here to serve you better.
											</span>
											<div class="summernote ans_area" id="m_summernote_1"></div>
                                                                                        <input id="ans_id" type="hidden" name="answer" value="" />
										</div>
									</div>
