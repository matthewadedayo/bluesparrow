<%-- 
    Document   : user_master_edit
    Created on : Jan 5, 2019, Jan 5, 2019 9:53:33 PM
    Author     : OLAWALE
--%>
...
//    ArrayList<Object[]> menuMasterObjectList = (ArrayList<Object[]>) request.getAttribute("menuMasterObjectList");
      Object[] userObjectEdit = (Object[]) request.getAttribute("userObject");
...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>BlueSparrow | Edit User</title>
...
<!--								<div class="m-dropdown m-dropdown--inline m-dropdown--arrow m-dropdown--align-right m-dropdown--align-push" m-dropdown-toggle="hover" aria-expanded="true">
					...
					<div class="m-content">
								...
								<div class="m-portlet m-portlet--tab m-portlet--center">
									...
									<!--begin::Form-->
									<form class="m-form m-form--fit m-form--label-align-right" action="save_user_details.htm?id=<%=userObjectEdit[0]%>" method="POST">
										<div class="m-portlet__body">
												<div class="form-group m-form__group row">
													<div class="col-lg-6 m-form__group-sub">
													<input type="text" name="first_name" class="form-control m-input" placeholder="First Name*" value="<%=userObjectEdit[2]%>">
													<span class="m-form__help"></span>
													</div>
													<div class="col-lg-6 m-form__group-sub">
													<input type="text" name="last_name" class="form-control m-input" placeholder="Last Name*" value="<%=userObjectEdit[3]%>">
													</div>
												</div>
												<div class="form-group m-form__group row">
													<div class="col-lg-6 m-form__group-sub">
													<input type="text" name="comp" class="form-control m-input" placeholder="Company*" value="<%=userObjectEdit[6]%>">
													<span class="m-form__help"></span>
													</div>
													<div class="col-lg-6 m-form__group-sub">
													<input type="text" name="desig" class="form-control m-input" placeholder="Designation*" value="<%=userObjectEdit[7]%>">
													</div>
												</div>
												<div class="form-group m-form__group row">
													<div class="col-lg-6 m-form__group-sub">
													<input type="email" name="email" class="form-control m-input" placeholder="Email*" value="<%=userObjectEdit[8]%>">
													<span class="m-form__help"></span>
													</div>
													<div class="col-lg-6 m-form__group-sub">
													<input type="tel" id="hp" name="phone" class="form-control m-input" placeholder="Mobile Number*" value="<%=userObjectEdit[9]%>">
													</div>
												</div>
										...
										<div class="form-group m-form__group row">
												<div class="col-lg-12 m-form__group-sub">
													<input type="text" name="username" class="form-control m-input" placeholder="UserName" value="<%=userObjectEdit[1]%>">
												</div>
										</div>
										<div class="form-group m-form__group row">
												<div class="col-lg-12 m-form__group-sub">
													<input type="password" name="password" class="form-control m-input" placeholder="Password" value="<%=userObjectEdit[4]%>">
												</div>
										</div>
										<div class="m-portlet__body">
											<div class="form-group m-form__group row">
												<label class="col-lg-12">
                                                                                                    <select class="form-control m-input m-input--square" id="" name="type">
													<%
                                                                                                            for(int i=0; i<userType.size(); ++i)
                                                                                                            {
                                                                                                                if(userType.containsKey(userObjectEdit[5]))
                                                                                                                {
                                                                                                                    %>
                                                                                                                    <option value="<%=userObjectEdit[5]%>"><%=userType.get(userObjectEdit[5])%></option>
                                                                                                                    <%
                                                                                                                    break;
                                                                                                                }
                                                                                                            ...
                                                                                                            {
                                                                                                                String key = itr.next();
                                                                                                                if(!key.equals(userObject[i]) && !key.equals(userObjectEdit[5]))
                                                                                                                {
