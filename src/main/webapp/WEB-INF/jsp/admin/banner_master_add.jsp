<%-- 
    Document   : banner_master_add
    Created on : Nov 22, 2018, Nov 22, 2018 12:03:38 PM
    Author     : OLAWALE
--%>
...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>BlueSparrow | Add Banner</title>
		<meta name="description" content="Add Banner">
						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="" class="m-nav__link">
											<span class="m-nav__link-text">Add Banner</span>
										</a>
									</li>
									<li class="m-nav__separator">-</li>
								</ul>
...
<!--							<div>
					...
					<div class="m-content">
								...
								<div class="m-portlet m-portlet--tab m-portlet--center">
									...
									<!--begin::Form-->
                                                                        <form class="m-form m-form--fit m-form--label-align-right" action="add_banner_master.htm" method="post" enctype="multipart/form-data">
										...
										<div class="form-group m-form__group row">
											<div class="col-lg-12 m-form__group-sub">
															...
															Portal*
                                                                                            ...
                                                                                            <select name="content_type_master_id" class="form-control m-input" required>
													<option disabled selected value="">Select Portal</option>
                                                                                                        <%
...
<!--													<option value="">Applications</option>
										...
										<div class="form-group m-form__group row">
												<div class="col-lg-12 m-form__group-sub">
													...
													<input type="text" name="title" class="form-control m-input" placeholder="Title" value="" required>
												</div>
										</div>
										...
										<div class="form-group m-form__group row">
											<div class="col-lg-12">
															...
															Banner Image*
                                                                                            ...
                                                                                            <input class="form-control m-input" id = "fileupload" type="file" name="banner_image" required/>
											</div>
										</div>
										...
										<div class="form-group m-form__group row">
											<div class="col-lg-12 m-form__group-sub">
												...
												<select name="size" class="form-control m-input" required>
													<option disabled selected value="">Select Size</option>
													<option value="1920x250">1920x250</option>
													<option value="1920x750">1920x750</option>
                                                                                                        
                                                                                                        <!--<option value="270x407">270x407</option>-->
                                                                                                        <!--<option value="470x189">470x189</option>-->
                                                                                                        <!--<option value="370x189">370x189</option>-->
                                                                                                        
                                                                                                        <option value="1452x599">1452x599</option>
                                                                                                        <option value="270x407">270x407</option>
                                                                                                        <option value="470x189">470x189</option>
                                                                                                        <!--<option value="370x189">370x189</option>-->
                                                                                                        <!--<option value="470x189">470x189</option>-->
                                                                                                        <option value="370x189">370x189</option>
                                                                                                        <option value="1920x1362">1920x1362</option>
												</select>
											</div>
										</div>
										...
										<div class="form-group m-form__group row">
												<div class="col-lg-12 m-form__group-sub">
													...
													<input type="text" name="url" class="form-control m-input" placeholder="Url" value="" required>
												</div>
										</div>
												...
												<div class="col-lg-12 m-form__group-sub">
													...
													<input type="text" name="dis_title" class="form-control m-input" placeholder="Display Title" value="">
												</div>
										</div>
                                                                                <div class="form-group m-form__group row">
												<div class="col-lg-12 m-form__group-sub">
															...
															Display Description
                                                                                                    ...
                                                                                                    <textarea class="form-control m-input" id="desc" placeholder="Brief Description" rows="3" name="dis_desc" maxlength="246"></textarea>
												...
												<div class="col-lg-12 m-form__group-sub">
													...
													<input type="text" name="dis_amount" class="form-control m-input" placeholder="Display Amount" value="">
												</div>
										</div>
                                                                                <div class="form-group m-form__group row">
												<div class="col-lg-12 m-form__group-sub">
													...
													<input type="text" name="dis_disc_percentage" class="form-control m-input" placeholder="Display Discount Percentage" value="">
												</div>
										</div>
												...
												<div class="col-lg-12 m-form__group-sub">
															...
															Start Date*
                                                                                                    ...
                                                                                                    <input id="datepicker"  name="start_date" class="form-control m-input " placeholder="Start on" value="" required>
												...
												<div class="col-lg-12 m-form__group-sub">
													...
													<input id="datepicker1"  name="end_date" class="form-control m-input" placeholder="Expire on" value="" required>
                    ...
                    $(document).ready(function()
    {
                        ...
                        var d = new Date();
                        var startDate = d.getFullYear() + "-" + (d.getMonth()+1) + "-" + d.getDate() + " 2:10";
                        var endDate = d.getFullYear()+1 + "-" + (d.getMonth()+1) + "-" + d.getDate() + " 2:10";
//                        alert(strDate);
