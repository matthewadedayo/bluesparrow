								...
								<div class="m-portlet__body">
									...
									<div class="form-group m-form__group row">
									  <div class="col-lg-12 col-md-12 col-sm-12">
											...
											<input type="email" class="form-control m-input m-input--square" id="exampleInputEmail1" placeholder="Subscription Name">
										</div>
									   ...
									   <input type="text" class="form-control m-input m-input--square" id="price" placeholder="Enter Price">
										   ...
										   <select class="form-control">
											...
											<div class="m-form__group form-group">
																...
																<div class="m-radio-list">
																		<label class="m-radio">
																		<input type="radio" name="example_1" value="1" checked>
																		AudeBook
																		<span></span>
