...
//    }
    ...
    public String getStatus(Object id, Object status)
    {
        ...
        {
            return "<a href=\"#\" title=\""+id+"\" class=\"btn-status btn-success edit_portal_cat_map_status\">Enabled</a><input type=\"hidden\" value=\"" + status + "\" />";
        }
        else
        {
            return "<a href=\"#\" title=\""+id+"\" class=\"btn-status btn-danger edit_portal_cat_map_status\">Disabled</a><input type=\"hidden\" value=\"" + status + "\" />";
        }
...
//    ArrayList<Object[]> menuMasterObjectList = (ArrayList<Object[]>) request.getAttribute("menuMasterObjectList");
      ...
      Object contentCategoryPortalMappingStatus = (Object) request.getAttribute("contentCategoryPortalMappingStatus");
//      ArrayList<Object[]> allPortalContentMappingObjectList = (ArrayList<Object[]>) request.getAttribute("allPortalContentMappingObjectList");
						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="" class="m-nav__link">
											<span class="m-nav__link-text">Category Mapping</span>
										</a>
									</li>
									<li class="m-nav__separator">-</li>
								</ul>
					...
					<div class="m-content">
							<!--begin::Portlet-->
								<div class="m-portlet m-portlet--tab m-portlet--center">
									...
									<!--begin::Form-->
									<form  class="m-form m-form--fit m-form--label-align-right" action="get_content_portal_cat_mpp.htm" method="post">
								...
								<div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
									<div class="row align-items-center">
										<div class="col-xl-8 order-2 order-xl-1">
                                                                                    <form id="load_by_title_frm" action="get_portal_cat_map_by_stat.htm" method="post">
														...
														<div class="m-form__control">
															<select class="form-control m-bootstrap-select sch_by" id="m_form_status" name="status">
																<%
                                                                                                                                    ...
                                                                                                                                    if(contentCategoryPortalMappingStatus==null)
                                                                                                                                    {
                                                                                                                                        %>
                                                                                                                                    ...
                                                                                                                                    
                                                                                                                                    {
                                                                                                                                        ...
                                                                                                                                        {
                                                                                                                                            if(status.containsKey(contentCategoryPortalMappingStatus.toString()))
                                                                                                                                            {
                                                                                                                                                %>
                                                                                                                                                <option value="<%=contentCategoryPortalMappingStatus%>"><%=status.get(contentCategoryPortalMappingStatus.toString())%></option>
                                                                                                                                                <%
                                                                                                                                                break;
                                                                                                                                            }
...
//                                                                                                                                            
                                                                                                                                            if(!key.equals(contentCategoryPortalMappingStatus.toString()))
                                                                                                                                            {
								...
								<table class="m-datatable" id="html_table" width="100%">
									<thead>
										<tr>
											...
											<th class="text-center" title="Field #3" data-field="content_cat">Content Category</th>
									...
									<tbody>
                                                                                ...
                                                                                <%
                                                                                                        if(allContentCategoryMasterObjectList!=null)
                                                                                                        {
                                                                                    ...
                                                                                    %>
										<tr>
                                                                                    <td><center><%= allContentCategoryMasterObjectList.get(count)[0]%></center></td>
                                                                                    <td><center><%= contentPortalMasterTitle %></center></td>
                                                                                    <td><center><%= allContentCategoryMasterObjectList.get(count)[1]%></center></td>
                                                                                    ...
                                                                                    <center>
                                                                                        <!--<label class="m-checkbox m-checkbox--state-primary">-->
                                                                                                ...
                                                                                                <%=getStatus(allContentCategoryMasterObjectList.get(count)[0], allContentCategoryMasterObjectList.get(count)[3])%>
                                                                                                <!--<span></span>-->
                                                                                        <!--</label>-->
                                                                                        </center>
                                                                                    </td>
...
<%
    ...
    %>
		...
		<script src="assets/app/js/html-table_2.js" type="text/javascript"></script>
