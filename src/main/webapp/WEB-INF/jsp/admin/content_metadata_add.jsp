...
<% 
    ...
    ArrayList<Object[]> allManuMappingList = (ArrayList<Object[]>)session.getAttribute("allManuMappingList");
      ...
      System.out.println("Another: " + contentMasterDisplay);
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title m-subheader__title--separator">Metadata</h3>
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="" class="m-nav__link">
											<span class="m-nav__link-text">Add Metadata</span>
										</a>
									</li>
									<li class="m-nav__separator">-</li>
								</ul>
					...
					<div class="m-content">
						...
						-->
									<!--begin::Form-->
                                                                        ...
                                                                        <form class="m-form m-form--fit m-form--label-align-right" action="add_content_meta_detail.htm" method="POST">
																...
																<div class="form-group m-form__group row">
																	<div class="col-lg-12">
																		<select name="content_meta_master_title" class="form-control m-input" required>
																...
																<div class="form-group m-form__group row">
																	<div class="col-lg-12">
																		...
																		<input type="text" name="content_mst_detail_value" class="form-control m-input" placeholder="Content Metadata" value="" required>
														...
														<div class="m-form__actions">
															<div class="row">
																<div class="col-lg-4 m--align-left">
																	<a href="bk_add_content_file?content_master_id=<%= contentMasterDisplay[0] %>&content_master_title=<%= contentMasterDisplay[1] %>&content_type_title=<%= contentMasterDisplay[2] %>&content_cat_title=<%= contentMasterDisplay[3] %>&content_sub_cat_title=<%= contentMasterDisplay[4] %>" class="btn btn-secondary m-btn m-btn--custom m-btn--icon" >
																		<span>
...
<!--																		<span>
																...
																<div class="col-lg-4 m--align-right">
																	<a href="mc_add_content_mster.htm" class="btn btn-primary m-btn m-btn--custom m-btn--icon" >
																		<span>
																			<i class="la la-check"></i>
																			<span id="more_btn">Add More Content</span>
																		</span>
																	</a>
																</div>
															</div>
																					...
																					<table class="table table-bordered">
																						...
																						<tbody>
                                                                                                                                                                                     <%
                                                                                                                                                                                        ...
                                                                                                                                                                                        %>
																							<tr>
																								<th scope="row"><%= contentMetaDetailsList.get(count)[0]%></th>
																								<!--<td></td>-->
