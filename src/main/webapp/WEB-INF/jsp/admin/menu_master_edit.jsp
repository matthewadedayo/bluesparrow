<%-- 
    Document   : menu_add
    Created on : Feb 12, 2019, Feb 12, 2019 2:56:58 PM
    Author     : OLAWALE
--%>
...
//      Object userId = (Object)request.getAttribute("user_id");
      ...
      Object[] menuMasterObject = (Object[]) request.getAttribute("menuMasterObject");
...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>BlueSparrow | Edit Menu</title>
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-content">
								...
								<div class="m-portlet m-portlet--tab m-portlet--center">
									...
									<!--begin::Form-->
									<form class="m-form m-form--fit m-form--label-align-right" action="save_menu_master_details.htm?id=<%=menuMasterObject[0]%>" method="post">
										<div class="m-portlet__body">
										<div class="form-group m-form__group row">
												<div class="col-lg-12 m-form__group-sub">
													<input type="text" name="title" class="form-control m-input" placeholder="Title" value="<%= menuMasterObject[1] %>">
												</div>
										</div>
										<div class="form-group m-form__group row">
												<div class="col-lg-12 m-form__group-sub">
													<input type="text" name="url" class="form-control m-input" placeholder="Url" value="<%= menuMasterObject[2] %>" >
												</div>
										</div>
										</div>
