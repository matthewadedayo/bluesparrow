<%-- 
    Document   : banner_master_list
    Created on : Dec 9, 2018, Dec 9, 2018 12:11:37 PM
    Author     : OLAWALE
--%>
...
//        return Integer.parseInt(statuInt.toString())==1?"ok":"del";
        return Integer.parseInt(statuInt.toString())==1?"<a href=\"#\" title=\""+id+"\" class=\"btn-status btn-success edit_banner_master_status\">Enabled</a>":"<a href=\"#\" title=\""+id+"\" class=\"btn-status btn-danger edit_banner_master_status\">Disabled</a>";
    }
...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>BlueSparrow | List Banner</title>
		<meta name="description" content="List Banner">
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title m-subheader__title--separator">Banner</h3>
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="" class="m-nav__link">
											<span class="m-nav__link-text">List Banner</span>
										</a>
									</li>
									<li class="m-nav__separator">-</li>
								</ul>
								...
								<div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
									<div class="row align-items-center">
										<div class="col-xl-8 order-2 order-xl-1">
                                                                                    <form action="get_banner_by_status_type.htm" id="load_by_title_frm" method="get">
												...
												<div class="col-md-4">
													<div class="m-form__group m-form__group--inline">
														...
														<div class="m-form__control">
															<select name="status" class="form-control m-bootstrap-select sch_by" id="m_form_status">
                                                                                                                            <%
                                                                                                                                System.out.println("hhh: " +bannerMasterStatus);
                                                                                                                                    if(bannerMasterStatus==null)
                                                                                                                                    {
                                                                                                                                        %>
                                                                                                                                    ...
                                                                                                                                    
                                                                                                                                    {
                                                                                                                                        ...
                                                                                                                                        {
                                                                                                                                            if(status.containsKey(bannerMasterStatus.toString()))
                                                                                                                                            {
                                                                                                                                                %>
                                                                                                                                                <option value="<%=bannerMasterStatus%>"><%=status.get(bannerMasterStatus.toString())%></option>
                                                                                                                                                <%
                                                                                                                                                break;
                                                                                                                                            }
...
//                                                                                                                                            if(!key.equals(allContentTypeMasterObjectList.get(i)[0].toString()) && !key.equals(contentTypeId.toString()))
                                                                                                                                            if(!key.equals(bannerMasterStatus.toString()))
                                                                                                                                            {
...
<!--																<option value="1">Online</option>
											...
											<a href="mc_add_banner_master.htm" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
												<span>
								...
								<table class="m-datatable" id="html_table" width="100%">
									<thead>
										<tr>
											...
											<th title="Field #2" class="text-center" data-field="portal">Portal</th>
											<th title="Field #3" class="text-center" data-field="menu">Title</th>
											<th title="Field #4" data-field="url">Url</th>
											<th title="Field #5" class="text-center" data-field="order">Size</th>
									...
									<tbody>
                                                                            <%
                                                                                for(int count=0; count<allBannerMasterObjectList.size(); ++count)
                                                                                {

                                                                                %>
										<tr title="Start on: <%=allBannerMasterObjectList.get(count)[7]%>, Expire on: <%=allBannerMasterObjectList.get(count)[8]%>">
                                                                                    <td><center><%= allBannerMasterObjectList.get(count)[0]%></center></td>
                                                                                        <td><center><%= allBannerMasterObjectList.get(count)[1]%></center></td>
											<td><center><%= allBannerMasterObjectList.get(count)[2]%></center></td>
											<td><%= allBannerMasterObjectList.get(count)[3]%></td>
											<td><center><%= allBannerMasterObjectList.get(count)[4]%></center></td>
                                                                                        <td><center><%= getStatus(allBannerMasterObjectList.get(count)[5], allBannerMasterObjectList.get(count)[0]) %><input type="hidden" value="<%= allBannerMasterObjectList.get(count)[4] %>" /></center></td>
											<td><center><a href="edit_banner_details.htm?id=<%=allBannerMasterObjectList.get(count)[0]%>" class="ico edit">Edit</a></center></td>
										</tr>
                                                                                <%
                                                                                    }
                                                                                %>
