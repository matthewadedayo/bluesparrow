<%-- 
    Document   : menu_child_add
    Created on : Feb 12, 2019, Feb 12, 2019 3:32:20 PM
    Author     : OLAWALE
--%>
...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>BlueSparrow | Add Menu Child</title>
		<meta name="description" content="Add Menu Child">
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="" class="m-nav__link">
											<span class="m-nav__link-text">Add Menu Child</span>
										</a>
									</li>
									<li class="m-nav__separator">-</li>
								</ul>
					...
					<div class="m-content">
								...
								<div class="m-portlet m-portlet--tab m-portlet--center">
									...
									<!--begin::Form-->
									<form class="m-form m-form--fit m-form--label-align-right" action="add_menu_child.htm" method="post">
										<div class="m-portlet__body">
											<div class="col-lg-12 m-form__group-sub">
												<label class="col-lg-12">
												<select class="form-control m-input m-input--square" id="" name="menu_id" >
...
<!--													<option value="">User</option>
										...
										<div class="form-group m-form__group row">
												<div class="col-lg-12 m-form__group-sub">
													<input type="text" name="url" class="form-control m-input" placeholder="Url" value="">
												</div>
										</div>
										</div>
