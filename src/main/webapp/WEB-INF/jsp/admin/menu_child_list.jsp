<%-- 
    Document   : menu_child_list
    Created on : Feb 12, 2019, Feb 12, 2019 3:37:36 PM
    Author     : OLAWALE
--%>
...
//    }
    ...
    {
//        return Integer.parseInt(statuInt.toString())==1?"ok":"del";
        return Integer.parseInt(statuInt.toString())==1?"<a href=\"#\" title=\""+id+"\" class=\"btn-status btn-success edit_menu_child_status\">Enabled</a>":"<a href=\"#\" title=\""+id+"\" class=\"btn-status btn-danger edit_menu_child_status\">Disabled</a>";
    }
...
//      Object userId = (Object)request.getAttribute("user_id");
      ...
      Object menuId = (Object) request.getAttribute("menuId");
      ArrayList<Object[]> allMenuMasterObjectList = (ArrayList<Object[]>) request.getAttribute("allMenuMasterObjectList");
      Object menuChildMasterStatus = (Object) request.getAttribute("menuChildMasterStatus");
      String feedback = (String) request.getAttribute("feedback");
      Map<String, String> type = new HashMap<String, String>();
      int next = 0;
      while(next < allMenuMasterObjectList.size())
      {
          type.put(allMenuMasterObjectList.get(next)[0].toString(), allMenuMasterObjectList.get(next)[1].toString());
          next++;
      }
...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>BlueSparrow | List Menu Child</title>
		<meta name="description" content="List Menu Child">
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title m-subheader__title--separator">Menu</h3>
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="" class="m-nav__link">
											<span class="m-nav__link-text">List Menu Child</span>
										</a>
									</li>
									<li class="m-nav__separator">-</li>
								</ul>
								...
								<div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
									<div class="row align-items-center">
										<div class="col-xl-8 order-2 order-xl-1">
                                                                                    <form action="get_menuchild_by_status_type.htm" id="load_by_title_frm" method="get">
														...
														<div class="m-form__control">
															<select class="form-control m-bootstrap-select sch_by" id="m_form_status" name="status">
                                                                                                                            <%
                                                                                                                                ...
                                                                                                                                System.out.println("hhh: " +menuChildMasterStatus);
                                                                                                                                    if(menuChildMasterStatus==null)
                                                                                                                                    {
                                                                                                                                        %>
                                                                                                                                    ...
                                                                                                                                    
                                                                                                                                    {
                                                                                                                                        ...
                                                                                                                                        {
                                                                                                                                            if(status.containsKey(menuChildMasterStatus.toString()))
                                                                                                                                            {
                                                                                                                                                %>
                                                                                                                                                <option value="<%=menuChildMasterStatus%>"><%=status.get(menuChildMasterStatus.toString())%></option>
                                                                                                                                                <%
                                                                                                                                                break;
                                                                                                                                            }
...
//                                                                                                                                            if(!key.equals(allContentTypeMasterObjectList.get(i)[0].toString()) && !key.equals(contentTypeId.toString()))
                                                                                                                                            if(!key.equals(menuChildMasterStatus.toString()))
                                                                                                                                            {
...
<!--																<option value="">All</option>
												...
												<div class="col-md-4">
													<div class="m-form__group m-form__group--inline">
														...
														<div class="m-form__control">
															<select class="form-control m-bootstrap-select sch_by" id="m_form_type" name="menu">
                                                                                                                            <%
                                                                                                                                    ...
                                                                                                                                    if(menuId==null)
                                                                                                                                    {
                                                                                                                                        ...
                                                                                                                                        %>
                                                                                                                                        <option value="<%=allMenuMasterObjectList.get(count)[0]%>"><%=allMenuMasterObjectList.get(count)[1]%></option>
                                                                                                                                        <%
                                                                                                                                        }
                                                                                                                                    }
                                                                                                                                    else
                                                                                                                                    {
                                                                                                                                        ...
                                                                                                                                        {
                                                                                                                                            if(type.containsKey(menuId.toString()))
                                                                                                                                            {
                                                                                                                                                %>
                                                                                                                                                <option value="<%=menuId%>"><%=type.get(menuId.toString())%></option>
                                                                                                                                                <%
                                                                                                                                                break;
                                                                                                                                            }
...
<!--																<option value="">All</option>
											...
											<a href="mc_add_menu_child.htm" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
												<span>
													<i class="la la-user"></i>
													<span>Add Menu Child</span>
												</span>
											</a>
								...
								<table class="m-datatable" id="html_table" width="100%">
									<thead>
										<tr>
											<th title="Field #1" class="text-center" data-field="ID">ID</th>
											<th title="Field #2" class="text-center" data-field="menu">Menu</th>
											<th title="Field #3" class="text-center" data-field="submenu">Submenu</th>
											<th title="Field #4" data-field="url">Url</th>
											<th title="Field #5" class="text-center" data-field="order">Order</th>
											<th title="Field #6" class="text-center" data-field="status">Status</th>
											<th title="Field #7" class="text-center" data-field="action">Action</th>
										</tr>
									</thead>
									<tbody>
                                                                            <%
                                                                              ...
                                                                              <tr>
                                                                                  <td><center><%= allMenuChildObjectList.get(count)[0]%></center></td>
                                                                                    ...
                                                                                    <td><%= allMenuChildObjectList.get(count)[3]%></td>
                                                                                    <td style="text-align: right"><center><%= allMenuChildObjectList.get(count)[4]%></center></td>
                                                                                    
                                                                                    <td><center><%= getStatus(allMenuChildObjectList.get(count)[5], allMenuChildObjectList.get(count)[0]) %><input type="hidden" value="<%= allMenuChildObjectList.get(count)[5] %>" /></center></td>
                                                                                    <td><center><a style="color: black" href="edit_menu_child_details.htm?id=<%=allMenuChildObjectList.get(count)[0]%>" class="ico edit edit_user" title="<%=allMenuChildObjectList.get(count)[0]%>">Edit</a></center></td>
...
//                    alert(msg);
                    ...
                    {
                         toastr.warning("User Already Exit");
                    }
                    }
                });
                </script>
