...
<!--							<div>
					...
					<div class="m-content">
						...
						-->
									<!--begin::Form-->
                                                                                    <form class="m-form m-form--fit m-form--label-align-right" action="add_content_master.htm" enctype="multipart/form-data" method="POST">
                                                                                        <input type="hidden" name="user_id" value="<%=userObject[0]%>">
																...
																<div class="form-group m-form__group row">
																	...
																	<div class="col-xl-9 col-lg-9">
																		<select name="type" id="cont_type" class="form-control m-input" required>
...
<!--																			<option value="">Puzzle</option>
									...
									<div class="form-group m-form__group row">
										...
										<div class="col-xl-9 col-lg-9">
											<select class="form-control m-input cont_sub_cat"  id="cont_sub_cat" name="cont_sub_cat_mst_id">
                                                                                        <!--<select class="form-control m-select2 cont_sub_cat" id="m_select2_3" name="cont_sub_cat_mst_id" multiple="multiple">-->
                                                                                            <option disabled selected value="">Select Sub Category</option>
<!--                                                                                            <optgroup label="FICTION" class="multi_sub">
												...
												<optgroup label="NON-FICTION">
													...
													<option value="WI">Sub-category-15</option>
																...
																<div class="form-group m-form__group row">
																	...
																	<div class="col-xl-9 col-lg-9">
																		<input id="title_size" type="text" class="form-control m-input" placeholder="Title" maxlength="50" value="" name="title"  required>
																...
																<div class="form-group m-form__group row">
																	...
																	<div class="col-xl-9 col-lg-9">
                                                                                                                                            <textarea id="desc_size" class="form-control m-input" id="desc" placeholder="Brief Description" rows="3" name="desc" maxlength="512" required></textarea>
																...
																<div class="form-group m-form__group row">
																	...
																	<div class="col-xl-9 col-lg-9">
																		...
																		<div style="display: none" class="file_load">
                                                                                                                                                    <input class="form-control m-input load" id = "small_thumb" type = "file" name="small_thumb" required />
																			<span class="m-form__help">
                                                                                                                                                ...
                                                                                                                                                <div style="display: none" class="url_text">
                                                                                                                                                    <input class="form-control m-input text" type="text" maxlength="264"  name="small_thumb_url" id="small_thumb_url" required autocomplete="off" placeholder="Thumbnail Small url*" />
<!--																			<span class="m-form__help">
																		...
																		<div style="display: none" class="file_load">
																			<input class="form-control m-input load" id = "middle_thumb" type = "file" name="middle_thumb" required />
																			<span class="m-form__help">
                                                                                                                                                ...
                                                                                                                                                <div style="display: none" class="url_text">
																			<input class="form-control m-input text" type="text" maxlength="264" name="middle_thumb_url" id="middle_thumb_url" required autocomplete="off" placeholder="Thumbnail Middle url*" />
<!--																			<span class="m-form__help">
																		...
																		<div style="display: none" class="file_load">
																			<input class="form-control m-input load" id = "large_thumb" type = "file" name="large_thumb" required />
																			<span class="m-form__help">
                                                                                                                                            ...
                                                                                                                                            <div style="display: none" class="url_text">
																			<input class="form-control m-input text" type="text" maxlength="264" name="large_thumb_url" id="large_thumb_url" required autocomplete="off" placeholder="Thumbnail Large url*" />
<!--																			<span class="m-form__help">
