<%-- 
    ...
    Created on : Jan 10, 2019, Jan 10, 2019 8:23:05 AM
    Author     : OLAWALE
--%>
...
//    }
    ...
    {
//        return Integer.parseInt(statuInt.toString())==1?"ok":"del";
        return Integer.parseInt(statuInt.toString())==1?"<a href=\"#\" title=\""+id+"\" class=\"btn-status btn-success edit_menu_mapping_status\">Enabled</a>":"<a href=\"#\" title=\""+id+"\" class=\"btn-status btn-danger edit_menu_mapping_status\">Disabled</a>";
    }
...
//      ArrayList<Object[]> userMasterObjectList = (ArrayList<Object[]>) request.getAttribute("userMasterObjectList");
      ArrayList<Object[]> allMenuMappingObjectList = (ArrayList<Object[]>) request.getAttribute("allMenuMappingObjectList");
...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>BlueSparrow | User Access</title>
		<meta name="description" content="User Access">
						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="" class="m-nav__link">
											<span class="m-nav__link-text">User Access</span>
										</a>
									</li>
									<li class="m-nav__separator">-</li>
								</ul>
								...
								<table class="m-datatable" id="html_table" width="100%">
									<thead>
										<tr>
											...
											<th class="text-center" title="Field #2" data-field="user">User</th>
											<th class="text-center" title="Field #3" data-field="menu">Menu</th>
											<th class="text-center" title="Field #4" data-field="submenu">Submenu</th>
											<th class="text-center" title="Field #5" data-field="status">Status</th>
										</tr>
									</thead>
									<tbody>
                                                                            <%
                                                                            for(int count=0; count<allMenuMappingObjectList.size(); ++count)
                                                                            {

                                                                            %>
										<tr>
											<td><center><%= allMenuMappingObjectList.get(count)[0]%></center></td>
											<td><center><%= allMenuMappingObjectList.get(count)[1]%></center></td>
											<td><center><%= allMenuMappingObjectList.get(count)[2]%></center></td>
											<td><center><%= allMenuMappingObjectList.get(count)[3]%></center></td>
                                                                                        <!--<td><center><a href="#" class="ico ok"></a></center></td>-->
                                                                                        <td><center><%= getStatus(allMenuMappingObjectList.get(count)[4], allMenuMappingObjectList.get(count)[0]) %><input type="hidden" value="<%= allMenuMappingObjectList.get(count)[4] %>" /></center></td>
										</tr>
                                                                                <%
                                                                                }
                                                                                %>
