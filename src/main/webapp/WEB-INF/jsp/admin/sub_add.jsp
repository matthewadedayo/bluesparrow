			...
			<div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-body">
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-content">
						...
						<div class="m-portlet">
							<!--begin::Form-->
                                                        <form class="m-form m-form--fit m-form--label-align-right" action="add_sub.htm" method="POST">
									  ...
									  <div class="col-lg-12 col-md-12 col-sm-12">
											<label for="exampleInputEmail1">
												Subscription
                                                                              ...
                                                                              <input type="text" name="sub_name" class="form-control m-input m-input--square" id="exampleInputEmail1" placeholder="Subscription Name">
										</div>
									   ...
									   <div class="alert alert-primary m--margin-top-10" role="alert">
											...
											Price
                                                                                    ...
                                                                                    <input type="text" name="sub_price" class="form-control m-input m-input--square" id="price" placeholder="Enter Price">
											...
											<div class="m-form__group form-group">
																...
																<div class="m-radio-list">
                                                                                                                                    <%
                                                                                                                                        ...
                                                                                                                                        %>
																		<label class="m-radio">
																		<input type="radio" class="portal_option" name="portal_id" value="<%= allContentPortalMasterObjectList.get(count)[0] %>">
...
<!--																<label Audebook>
																	...
																	<div class="m-checkbox-inline">
																		...
																		<label class="m-checkbox">
                                                                                                                                                    <input type="checkbox" name="ftext">
																			ddd
																			<span></span>
																		</label>
