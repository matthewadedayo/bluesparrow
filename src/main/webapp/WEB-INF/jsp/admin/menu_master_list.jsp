<%-- 
    Document   : menu_list
    Created on : Feb 12, 2019, Feb 12, 2019 2:47:00 PM
    Author     : OLAWALE
--%>
...
//    }
    ...
    {
//        return Integer.parseInt(statuInt.toString())==1?"ok":"del";
        return Integer.parseInt(statuInt.toString())==1?"<a href=\"#\" title=\""+id+"\" class=\"btn-status btn-success edit_menu_master_status\">Enabled</a>":"<a href=\"#\" title=\""+id+"\" class=\"btn-status btn-danger edit_menu_master_status\">Disabled</a>";
    }
%>
<% 
...
//      Object userId = (Object)request.getAttribute("user_id");
      ...
      Object menuMasterStatus = (Object) request.getAttribute("menuMasterStatus");
...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>BlueSparrow | List Menu</title>
						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="" class="m-nav__link">
											<span class="m-nav__link-text">List Menu</span>
										</a>
									</li>
									<li class="m-nav__separator">-</li>
								</ul>
												...
												<div class="col-md-4">
													<div class="m-form__group m-form__group--inline">
														...
														<div class="m-form__control">
                                                                                                                    <form action="get_menu_by_status_type.htm" id="load_by_title_frm" method="get">
															<select name="status" class="form-control m-bootstrap-select sch_by" id="m_form_status">
                                                                                                                            <%
                                                                                                                                System.out.println("hhh: " +menuMasterStatus);
                                                                                                                                    if(menuMasterStatus==null)
                                                                                                                                    {
                                                                                                                                        %>
                                                                                                                                    ...
                                                                                                                                    
                                                                                                                                    {
                                                                                                                                        ...
                                                                                                                                        {
                                                                                                                                            if(status.containsKey(menuMasterStatus.toString()))
                                                                                                                                            {
                                                                                                                                                %>
                                                                                                                                                <option value="<%=menuMasterStatus%>"><%=status.get(menuMasterStatus.toString())%></option>
                                                                                                                                                <%
                                                                                                                                                break;
                                                                                                                                            }
...
//                                                                                                                                            if(!key.equals(allContentTypeMasterObjectList.get(i)[0].toString()) && !key.equals(contentTypeId.toString()))
                                                                                                                                            if(!key.equals(menuMasterStatus.toString()))
                                                                                                                                            {
...
<!--																<option value="">All</option>
											...
											<a href="mc_add_menu.htm" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
												<span>
								...
								<table class="m-datatable" id="html_table" width="100%">
									<thead>
										<tr>
											...
											<th class="text-center" title="Field #2" data-field="menu">Menu</th>
											<th class="text-center" title="Field #3" data-field="url">Url</th>
											<th class="text-center" title="Field #4" data-field="order">Order</th>
											<th class="text-center" title="Field #5" data-field="status">Status</th>
											<th class="text-center" title="Field #6" data-field="action">Action</th>
										</tr>
									</thead>
									<tbody>
                                                                            <%
                                                                              ...
                                                                              <tr>
                                                                                  <td><center><%= allMenuMasterObjectList.get(count)[0]%></center></td>
                                                                                    ...
                                                                                    <td><center><%= allMenuMasterObjectList.get(count)[2]%></center></td>
                                                                                    <td style="text-align: right"><center><%= allMenuMasterObjectList.get(count)[3]%></center></td>
                                                                                    
                                                                                    <td><center><%= getStatus(allMenuMasterObjectList.get(count)[4], allMenuMasterObjectList.get(count)[0]) %><input type="hidden" value="<%= allMenuMasterObjectList.get(count)[4] %>" /></center></td>
                                                                    <td><center><a style="color: black" href="edit_menu_master_details.htm?id=<%=allMenuMasterObjectList.get(count)[0]%>" class="ico edit edit_user" title="<%=allMenuMasterObjectList.get(count)[0]%>">Edit</a></center> </td>
