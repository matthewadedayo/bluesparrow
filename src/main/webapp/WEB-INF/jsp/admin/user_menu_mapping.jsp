...
<%!
    public String getStatus(Object id, Object status)
    {
        ...
        {
            return "<a href=\"#\" title=\""+id+"\" class=\"btn-status btn-success add_priviledge\">Enabled</a><input type=\"hidden\" value=\"" + status + "\" />";
        }
        else
        {
            return "<a href=\"#\" title=\""+id+"\" class=\"btn-status btn-danger add_priviledge\">Disabled</a><input type=\"hidden\" value=\"" + status + "\" />";
        }
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-content">
								...
								<div class="m-portlet m-portlet--tab m-portlet--center">
									...
									<!--begin::Form-->
									<form class="m-form m-form--fit m-form--label-align-right" action="get_role_menu_map.htm">
										<div class="m-portlet__body">
											<div class="form-group m-form__group">
												<label class="col-lg-12">
												<select class="form-control m-input m-input--square" id="roleType" name="roleType">
                                                                                                    <%
                                                                                                        if(roleType==null)
                                                                                                        {
                                                                                                    %>
...
<!--											<th title="Field #1" data-field="ID">ID</th>
									...
									<tbody>
                                                                            <%
                                                                                                        if(allMenuMasterObjectList!=null)
                                                                                                        {
                                                                                    ...
                                                                                    %>
										<tr>
                                                                                    <td><center><%= allMenuMasterObjectList.get(count)[0]%></center></td>
                                                                                    <td><center><%= roleType %></center></td>
                                                                                    <td><center><%= allMenuMasterObjectList.get(count)[1]%></center></td>
                                                                                    ...
                                                                                    <center>
                                                                                        <!--<label class="m-checkbox m-checkbox--state-primary">-->
                                                                                                ...
                                                                                                <%=getStatus(allMenuMasterObjectList.get(count)[0], allMenuMasterObjectList.get(count)[4])%>
                                                                                                <!--<span></span>-->
                                                                                        <!--</label>-->
                                                                                        </center>
                                                                                    </td>
