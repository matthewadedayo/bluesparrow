			...
			<div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-body">
								...
								<div class="m-menu__submenu "><span class="m-menu__arrow"></span>
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item " aria-haspopup="true"><a href="mc_list_content_portal.htm" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">List Portal</span></a></li>
                                                                                <li class="m-menu__item " aria-haspopup="true"><a href="#" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Portal Content Type mapping</span></a></li>
										<li class="m-menu__item " aria-haspopup="true"><a href="#" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Portal Category Mapping</span></a></li>
										<li class="m-menu__item " aria-haspopup="true"><a href="@" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Portal Content Restriction</span></a></li>
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-content">
						...
						-->
									<!--begin::Form-->
									<form class="m-form m-form--fit m-form--label-align-right"  method="post" enctype="multipart/form-data" action="add_content_file.htm">
																...
																<div class="form-group m-form__group row">
																	<div class="col-lg-12">
																		...
																		<input type="text" name="width_height" class="form-control m-input" placeholder="e.g 400x600" value="">
																...
																<div class="form-group m-form__group row">
																	<div class="col-lg-6 m-form__group-sub">
																		...
																		<select name="os_name" class="form-control m-input">
																	...
																	<div class="col-lg-6 m-form__group-sub">
																		...
																		<input type="text" name="os_version" class="form-control m-input" required placeholder="e.g. 5.0" value="" pattern="[0-9].[0-9]{1,3}">
														...
														<div class="m-form__actions">
															<div class="row">
																<div class="col-lg-6 m--align-left">
																	<a href="mc_add_content_mster.htm" class="btn btn-secondary m-btn m-btn--custom m-btn--icon" >
																		<span>
...
<!--                                                                                                                                                <span>
																	...
																	<!--</a>-->
                                                                                                                                        <!--<button id="cont_btn1" data-toggle="modal" data-target="#m_modal_content_file" class="btn btn-success m-btn m-btn--custom m-btn--icon btn btn-focus">Continue</button>-->
																	<a href="#" class="btn btn-success m-btn m-btn--custom m-btn--icon btn btn-focus" >
																		<span>
			
																			<span id="cont_btn1" data-toggle="modal" data-target="#m_modal_content_file">Continue</span>
													...
													<div class="m-portlet__foot m-portlet__foot--fit m--margin-top-40">	</div>													
                                                                            ...
                                                                            %>
															<!-- Modal -->
						<div id="dia_log" class="modal fade" id="m_modal_content_file" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
...
<!--										<button type="button" class="btn btn-primary">Save changes</button>-->
                                                                                ...
                                                                                <a id="save_cont" href="mc_add_md_content.htm?content_master_id=<%= contentMasterDisplay[0] %>&content_master_title=<%= contentMasterDisplay[1] %>&content_type_title=<%= contentMasterDisplay[2] %>&content_cat_title=<%= contentMasterDisplay[3] %>&content_sub_cat_title=<%= contentMasterDisplay[4] %>" class="btn btn-primary">Save changes</a>
									</div>
								</div>
							</div>
						</div>
                                                                        
                                                <div class="modal fade" id="m_modal_upload_file" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title" id="exampleModalLongTitle">Alert!</h5>
...
<!--																								<td></td>
																								...
																								<!--<td><button type="button" class="btn-status btn-primary">Pending</button></td>-->
                                                                                                                                                                                                <td><center><a href="#" class="ico edit"></a> Edit</center></td>
																							</tr>
                                                                                                                                                                                        <%
                                                                                                                                                                                            }
                                                                                                                                                                                        %>
