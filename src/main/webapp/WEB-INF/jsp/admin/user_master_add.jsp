<%-- 
    Document   : add_user
    Created on : Oct 30, 2018, Oct 30, 2018 5:26:46 AM
    Author     : OLAWALE
--%>
...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>BlueSparrow | Add User</title>
...
<!--							<div>
					...
					<div class="m-content">
								...
								<div class="m-portlet m-portlet--tab m-portlet--center">
									...
									<!--begin::Form-->
									<form class="m-form m-form--fit m-form--label-align-right" action="add_user.htm" method="POST">
										<div class="m-portlet__body">
												<div class="form-group m-form__group row">
													<div class="col-lg-6 m-form__group-sub">
													<input type="text" name="first_name" class="form-control m-input" placeholder="First Name*" value="">
													<span class="m-form__help"></span>
													</div>
													<div class="col-lg-6 m-form__group-sub">
													<input type="text" name="last_name" class="form-control m-input" placeholder="Last Name*" value="">
													</div>
												</div>
												<div class="form-group m-form__group row">
													<div class="col-lg-6 m-form__group-sub">
													<input type="text" name="comp" class="form-control m-input" placeholder="Company*" value="">
													<span class="m-form__help"></span>
													</div>
													<div class="col-lg-6 m-form__group-sub">
													<input type="text" name="desig" class="form-control m-input" placeholder="Designation*" value="">
													</div>
												</div>
												<div class="form-group m-form__group row">
													<div class="col-lg-6 m-form__group-sub">
													<input type="email" name="email" class="form-control m-input" placeholder="Email*" value="">
													<span class="m-form__help"></span>
													</div>
													<div class="col-lg-6 m-form__group-sub">
													<input type="tel" id="hp" name="phone" class="form-control m-input" placeholder="Mobile Number*" value="ph_number">
													</div>
												</div>
										...
										<div class="form-group m-form__group row">
												<div class="col-lg-12 m-form__group-sub">
													<input type="text" name="username" class="form-control m-input" placeholder="UserName" value="">
												</div>
										</div>
										<div class="form-group m-form__group row">
												<div class="col-lg-12 m-form__group-sub">
