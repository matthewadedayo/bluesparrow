...
//    ArrayList<Object[]> menuMasterObjectList = (ArrayList<Object[]>) request.getAttribute("menuMasterObjectList");
      Object[] menuChildObject = (Object[]) request.getAttribute("menuChildObject");
...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>BlueSparrow | Edit Menu Child</title>
		<meta name="description" content="Edit Menu Child">
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="" class="m-nav__link">
											<span class="m-nav__link-text">Edit Menu Child</span>
										</a>
									</li>
									<li class="m-nav__separator">-</li>
								</ul>
					...
					<div class="m-content">
								...
								<div class="m-portlet m-portlet--tab m-portlet--center">
									...
									<!--begin::Form-->
									<form class="m-form m-form--fit m-form--label-align-right" action="save_menu_child_details.htm?id=<%=menuChildObject[0]%>" method="post">
										<div class="m-portlet__body">
											
                                                                                <div class="form-group m-form__group row">
												<div class="col-lg-12 m-form__group-sub">
													<input type="text" name="menu_title" class="form-control m-input" placeholder="Title" value="<%=menuChildObject[1]%>" disabled>
												</div>
										</div>
										<div class="form-group m-form__group row">
												<div class="col-lg-12 m-form__group-sub">
													<input type="text" name="title" class="form-control m-input" placeholder="Title" value="<%=menuChildObject[2]%>">
												</div>
										</div>
										<div class="form-group m-form__group row">
												<div class="col-lg-12 m-form__group-sub">
													<input type="text" name="url" class="form-control m-input" placeholder="Url" value="<%=menuChildObject[3]%>">
												</div>
										</div>
										</div>
