<%-- 
    Document   : portal_category_mapp
    Created on : Dec 27, 2018, Dec 27, 2018 6:42:43 AM
    Author     : OLAWALE
--%>
...
//    public String getStatus(Object statuInt)
//    {
//        return Integer.parseInt(statuInt.toString())==1?"checked":"";
//    }

    public String getStatus(Object id, Object status, String portal)
    {
//        if(portal.equals("Nil"))
//        {
//            return "<a href=\"#/\" title=\""+id+"\" class=\"btn-status btn-info\">Disabled</a><input type=\"hidden\" value=\"" + status + "\" />";
//        }
//        else
//        {
            if(status.toString().equals("1"))
            {
                return "<a href=\"#\" title=\""+id+"\" class=\"btn-status btn-success edit_portal_cont_map_status\">Enabled</a><input type=\"hidden\" value=\"" + status + "\" />";
            }
            else
            {
                return "<a href=\"#\" title=\""+id+"\" class=\"btn-status btn-danger edit_portal_cont_map_status\">Disabled</a><input type=\"hidden\" value=\"" + status + "\" />";
            }
//        }
...
//    ArrayList<Object[]> menuMasterObjectList = (ArrayList<Object[]>) request.getAttribute("menuMasterObjectList");
      ...
      ArrayList<Object[]> allUserMasterObjectList = (ArrayList<Object[]>) request.getAttribute("allUserMasterObjectList");
      ...
      String userMaster = (String) request.getAttribute("userMaster");
      String contentTypeMaster = (String) request.getAttribute("contentTypeMaster");
      String contentCategoryMaster = (String) request.getAttribute("contentCategoryMaster");
      
      
      String contentPortalMasterId = (String) request.getAttribute("contentPortalMasterId");
      
      Map<String, String> portal = new HashMap<String, String>();
      int next = 0;
      while(next < allContentPortalMasterObjectList.size())
      {
//          System.out.println("tp: " + allContentPortalMasterObjectList.get(next)[1].toString());
          portal.put(allContentPortalMasterObjectList.get(next)[0].toString(), allContentPortalMasterObjectList.get(next)[1].toString());
          next++;
      }

      
      String contentPortalMasterTitle = contentPortalMasterId!=null ? portal.get(contentPortalMasterId) : "Nil";
      
      Map<String, String> user = new HashMap<String, String>();
      int us = 0;
      while(us < allUserMasterObjectList.size())
      {
//          System.out.println("tp: " + allUserMasterObjectList.get(us)[1].toString());
          user.put(allUserMasterObjectList.get(us)[1].toString(), allUserMasterObjectList.get(us)[0].toString());
          us++;
      }
      
      Map<String, String> cType = new HashMap<String, String>();
      int ct = 0;
      while(ct < allContentTypeMasterObjectList.size())
      {
//          System.out.println("tp: " + allContentTypeMasterObjectList.get(ct)[1].toString());
          cType.put(allContentTypeMasterObjectList.get(ct)[1].toString(), allContentTypeMasterObjectList.get(ct)[0].toString());
          ct++;
      }
      
      Map<String, String> cCategory = new HashMap<String, String>();
      int cc = 0;
      while(cc < allContentCategoryMasterObjectList.size())
      {
//          System.out.println("tp--: " + allContentCategoryMasterObjectList.get(cc)[0].toString());
          cCategory.put(allContentCategoryMasterObjectList.get(cc)[1].toString(), allContentCategoryMasterObjectList.get(cc)[0].toString());
          cc++;
      }
...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>BlueSparrow | Portal Category Mapping</title>
		<meta name="description" content="Portal Category Mapping">
											...
											<div class="m-menu__submenu "><span class="m-menu__arrow"></span>
												<ul class="m-menu__subnav">
													...
													<li class="m-menu__item" aria-haspopup="true"><a href="mc_list_banner_master.htm" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">List Banner</span></a></li>
                                                        ...
                                                        <li class="m-menu__item  m-menu__item--submenu m-menu__item--open m-menu__item--expanded" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="javascript:;" class="m-menu__link m-menu__toggle"><i class="m-menu__link-icon flaticon-layers"></i><span class="m-menu__link-text">Publisher</span><i
									 class="m-menu__ver-arrow la la-angle-right"></i></a>
								<div class="m-menu__submenu "><span class="m-menu__arrow"></span>
									<ul class="m-menu__subnav">
					...
					<div class="m-content">
							<!--begin::Portlet-->
								<div class="m-portlet m-portlet--tab m-portlet--center">
									...
									<!--begin::Form-->
									<form class="m-form m-form--fit m-form--label-align-right" action="get_portal_content_mpp.htm" method="post">
										<div class="m-portlet__body">
											<div class="form-group m-form__group">
												...
												<select class="form-control m-input m-input--square" id="cont_portal" name="content_portal_master" required>
													<%
                                                                                                                                    
                                                                                                                                    if(contentPortalMasterId==null)
                                                                                                                                    {
                                                                                                                                        %>
                                                                                                                                        ...
                                                                                                                                        %>
                                                                                                                                        <option value="<%=allContentPortalMasterObjectList.get(count)[0]%>"><%=allContentPortalMasterObjectList.get(count)[1]%></option>
                                                                                                                                        <%
                                                                                                                                        }
                                                                                                                                    }
                                                                                                                                    else
                                                                                                                                    {
                                                                                                                                        ...
                                                                                                                                        {
                                                                                                                                            if(portal.containsKey(contentPortalMasterId.toString()))
                                                                                                                                            {
                                                                                                                                                %>
                                                                                                                                                <option value="<%=contentPortalMasterId%>"><%=portal.get(contentPortalMasterId.toString())%></option>
                                                                                                                                                <%
                                                                                                                                                break;
                                                                                                                                            }
...
//                                                                                                                                            if(!key.equals(allContentTypeMasterObjectList.get(i)[0].toString()) && !key.equals(contentTypeId.toString()))
                                                                                                                                            if(!key.equals(contentPortalMasterId.toString()))
                                                                                                                                            {
//                                                                                                                                                System.out.println(key + ":" + portal.get(key));
                                                                                                                                                 %>
                                                                                                                                                <option value="<%=key%>"><%=portal.get(key)%></option>
                                                                                                                                                <%
                                                                                                                                                ++i;
                                                                                                                                            }
                                                                                                                                        }
											...
											<div class="form-group m-form__group">
												...
												<select class="form-control m-input m-input--square other_select" id="" name="user_master">
                                                                                                        ...
                                                                                                        <%
                                                                                                                                    ...
                                                                                                                                    {
                                                                                                                                        %>
                                                                                                                                        <option  selected value="">Select Content Partner*</option>
                                                                                                                                        <%
                                                                                                                                        for(int count=0; count<allUserMasterObjectList.size(); ++count)
                                                                                                                                        {

                                                                                                                                        %>
                                                                                                                                        <option value="<%=allUserMasterObjectList.get(count)[1]%>"><%=allUserMasterObjectList.get(count)[0]%></option>
                                                                                                                                        <%
                                                                                                                                        }
                                                                                                                                    }
                                                                                                                                    else
...
//                                                                                                                                        System.out.println("OTHER USER");
                                                                                                                                        ...
                                                                                                                                        {
                                                                                                                                            if(user.containsKey(userMaster.toString()))
                                                                                                                                            {
                                                                                                                                                %>
                                                                                                                                                <option value="<%=userMaster%>"><%=user.get(userMaster.toString())%></option>
                                                                                                                                                <%
                                                                                                                                                break;
                                                                                                                                            }
                                                                                                                                        ...
                                                                                                                                        while(itr.hasNext())
                                                                                                                                        {
                                                                                                                                            String key = itr.next();
//                                                                                                                                            if(!key.equals(allContentTypeMasterObjectList.get(i)[0].toString()) && !key.equals(contentTypeId.toString()))
                                                                                                                                            if(!key.equals(userMaster.toString()))
                                                                                                                                            {
                                                                                                                                                System.out.println(key + ":" + user.get(key));
                                                                                                                                                 %>
                                                                                                                                                <option value="<%=key%>"><%=user.get(key)%></option>
                                                                                                                                                <%
                                                                                                                                                ++i;
                                                                                                                                            }
                                                                                                                                        }
...
<!--													<option value="">Puzzle Puzzle Game</option>
													...
													<option value="">Art Art Book</option>
													<option value="">Fiction Fiction Ebook</option>
													<option value="">Whitepaper Whitepaper Audiobook</option>-->
												</select>
											</div>
										</div>
										<div class="m-portlet__body">
											<div class="form-group m-form__group">
												...
												<select class="form-control m-input m-input--square other_select" id="" name="content_type_master">
                                                                                                        ...
                                                                                                        <%
                                                                                                                                    ...
                                                                                                                                    if(contentTypeMaster==null)
                                                                                                                                    {
                                                                                                                                        ...
                                                                                                                                        %>
                                                                                                                                        <option value="<%=allContentTypeMasterObjectList.get(count)[1]%>"><%=allContentTypeMasterObjectList.get(count)[0]%></option>
                                                                                                                                        <%
                                                                                                                                        }
                                                                                                                                    }
                                                                                                                                    else
...
//                                                                                                                                        System.out.println("OTHERS.....");
                                                                                                                                        ...
                                                                                                                                        {
                                                                                                                                            if(user.containsKey(contentTypeMaster.toString()))
                                                                                                                                            {
                                                                                                                                                %>
                                                                                                                                                <option value="<%=contentTypeMaster%>"><%=cType.get(contentTypeMaster.toString())%></option>
                                                                                                                                                <%
                                                                                                                                                break;
                                                                                                                                            }
                                                                                                                                        ...
                                                                                                                                        while(itr.hasNext())
                                                                                                                                        {
                                                                                                                                            String key = itr.next();
//                                                                                                                                            if(!key.equals(allContentTypeMasterObjectList.get(i)[0].toString()) && !key.equals(contentTypeId.toString()))
                                                                                                                                            if(!key.equals(contentTypeMaster.toString()))
                                                                                                                                            {
//                                                                                                                                                System.out.println(key + ":" + cType.get(key));
                                                                                                                                                 %>
                                                                                                                                                <option value="<%=key%>"><%=cType.get(key)%></option>
                                                                                                                                                <%
                                                                                                                                                ++i;
                                                                                                                                            }
                                                                                                                                        }
...
<!--													<option value="">Puzzle Puzzle Game</option>
											...
											<div class="form-group m-form__group">
												...
												<select class="form-control m-input m-input--square other_select" id="" name="content_category_master">
													
                                                                                                        <%
//                                                                                                                                    System.out.println("ghjjhg");
                                                                                                                                    if(contentCategoryMaster==null)
                                                                                                                                    {
                                                                                                                                        %>
                                                                                                                                        <option  selected value="">Select Content Category</option>
                                                                                                                                        <%
                                                                                                                                        for(int count=0; count<allContentCategoryMasterObjectList.size(); ++count)
                                                                                                                                        {

                                                                                                                                        %>
                                                                                                                                        <option value="<%=allContentCategoryMasterObjectList.get(count)[1]%>"><%=allContentCategoryMasterObjectList.get(count)[0]%></option>
                                                                                                                                        <%
                                                                                                                                        }
                                                                                                                                    }
                                                                                                                                    else
                                                                                                                                    {
//                                                                                                                                        System.out.println("OTHERS.....");
                                                                                                                                        for(int i=0; i<cCategory.size(); ++i)
                                                                                                                                        {
                                                                                                                                            if(cCategory.containsKey(contentCategoryMaster.toString()))
                                                                                                                                            {
                                                                                                                                                %>
                                                                                                                                                <option value="<%=contentCategoryMaster%>"><%=cCategory.get(contentCategoryMaster.toString())%></option>
                                                                                                                                                <%
                                                                                                                                                break;
                                                                                                                                            }
                                                                                                                                        ...
                                                                                                                                        <%
                                                                                                                                        Set<String> keys = cCategory.keySet();
                                                                                                                                        Iterator<String> itr = keys.iterator();
                                                                                                                                        ...
                                                                                                                                        while(itr.hasNext())
                                                                                                                                        {
                                                                                                                                            String key = itr.next();
//                                                                                                                                            if(!key.equals(allContentTypeMasterObjectList.get(i)[0].toString()) && !key.equals(contentTypeId.toString()))
                                                                                                                                            if(!key.equals(contentCategoryMaster.toString()))
                                                                                                                                            {
//                                                                                                                                                System.out.println(key + ":" + cType.get(key));
                                                                                                                                                 %>
                                                                                                                                                <option value="<%=key%>"><%=cCategory.get(key)%></option>
                                                                                                                                                <%
                                                                                                                                                ++i;
                                                                                                                                            }
                                                                                                                                        }
...
{
    %>
						<div class="m-portlet m-portlet--mobile" id="table_cont">
							<div class="m-portlet__head">
								<div class="m-portlet__head-caption">
								<div class="m-portlet__head-title">
										<h3 class="m-portlet__head-text">
...
<!--												<div class="col-md-4">
								...
								<table class="m-datatable" id="html_table" width="100%">
									<thead>
										<tr>
											<th class="text-center" title="Field #1" data-field="ID">Id</th>
                                                                                        
                                                                                        <th class="text-center" title="Field #1" data-field="User">User</th>
											<!--<th class="text-center" title="Field #2" data-field="content_portal">Content Portal</th>-->
											<th class="text-center" title="Field #3" data-field="content_Type">Content Type</th>
											<th title="Field #4" data-field="sub_content_cat">Content Category</th>
                                                                                        
                                                                                        <th class="text-center" title="Field #4" data-field="Portal">Portal</th>
                                                                                        <th class="text-center" title="Field #1" data-field="Title">Content Title</th>
											<th class="text-center" title="Field #5" data-field="status">Status</th>											
										</tr>
									</thead>
									<tbody>
										...
										<tr>
                                                                                    ...
                                                                                    <td><center><%= allContentMasterObjectList.get(count)[2]%></center></td>
                                                                                    
                                                                                    <td><center><%= allContentMasterObjectList.get(count)[3]%></center></td>
                                                                                    <td><center><%= allContentMasterObjectList.get(count)[4]%></center></td>
                                                                                    <td><center><%= contentPortalMasterTitle%></center></td>
                                                                                    <td><center><%= allContentMasterObjectList.get(count)[1]%></center></td>
                                                                                    <td>
                                                                                    <center>
                                                                                                
                                                                                                <%=getStatus(allContentMasterObjectList.get(count)[0], allContentMasterObjectList.get(count)[5], contentPortalMasterTitle)%>
                                                                                                <span></span>
                                                                                        </center>
                                                                                    </td>
										</tr>
