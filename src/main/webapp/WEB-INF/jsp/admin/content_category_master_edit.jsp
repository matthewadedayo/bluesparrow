...
<!--							<div>
					...
					<div class="m-content">
								...
								<div class="m-portlet m-portlet--tab m-portlet m-portlet--center">
									...
									<!--begin::Form-->
                                                                        <form class="m-form m-form--fit m-form--label-align-right" action="save_content_cat_mst_details.htm?id=<%=contentCategoryMasterObject[0]%>" method="post">
										<div class="m-portlet__body">
												<div class="form-group m-form__group row">							
													...
													<input type="text" name="content_type_id" class="form-control m-input" placeholder="Enter Title" value="<%=contentCategoryMasterObject[3]%>" disabled>
												...
												<div class="form-group m-form__group row">
													...
													<input type="text" name="title" class="form-control m-input" placeholder="Enter Title" value="<%=contentCategoryMasterObject[1]%>" required>
													...
													<input type="text" name="local_title" class="form-control m-input" placeholder="Local Title" value="<%=contentCategoryMasterObject[2]%>" required>
														<span class="m-form__help">
