...
//        return Integer.parseInt(statuInt.toString())==1?"ok":"del";
        return Integer.parseInt(statuInt.toString())==1?"<a href=\"#\" title=\""+id+"\" class=\"btn-status btn-success edit_content_portal_master_status\">Enable</a>":"<a href=\"#\" title=\""+id+"\" class=\"btn-status btn-danger edit_content_portal_master_status\">Disable</a>";
    }
...
//        ArrayList<Object[]> allContentTypeMasterObjectList = (ArrayList<Object[]>) request.getAttribute("allContentTypeMasterObjectList");
      ...
      Object contentPortalStatus = (Object) request.getAttribute("contentPortalStatus");
...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>BlueSparrow | List Portal</title>
		<meta name="description" content="List Portal">
						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="" class="m-nav__link">
											<span class="m-nav__link-text">List Portal</span>
										</a>
									</li>
									<li class="m-nav__separator">-</li>
								</ul>
								...
								<div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
									<div class="row align-items-center">
										<div class="col-xl-8 order-2 order-xl-1">
                                                                                    <form action="get_portal_by_status.htm" id="load_by_title_frm" method="get">
													...
													<div class="m-form__group m-form__group--inline">
														...
														<div class="m-form__control">
															<select class="form-control m-bootstrap-select sch_by" id="m_form_status" name="status">
                                                                                                                            <%
                                                                                                                                System.out.println("hhh: " +contentPortalStatus);
                                                                                                                                    if(contentPortalStatus==null)
                                                                                                                                    {
                                                                                                                                        %>
                                                                                                                                    ...
                                                                                                                                    
                                                                                                                                    {
                                                                                                                                        ...
                                                                                                                                        {
                                                                                                                                            if(status.containsKey(contentPortalStatus.toString()))
                                                                                                                                            {
                                                                                                                                                %>
                                                                                                                                                <option value="<%=contentPortalStatus%>"><%=status.get(contentPortalStatus.toString())%></option>
                                                                                                                                                <%
...
//                                                                                                                                            if(!key.equals(allContentTypeMasterObjectList.get(i)[0].toString()) && !key.equals(contentTypeId.toString()))
                                                                                                                                            if(!key.equals(contentPortalStatus.toString()))
                                                                                                                                            {
...
//                                                                                                                                                ++z;
								...
								<table class="m-datatable" id="html_table" width="100%">
									<thead>
										<tr>
											<th title="Field #1" data-field="ID" class="text-center">ID</th>
											<th title="Field #2" data-field="portal" class="text-center">Title</center></th>
											<th title="Field #4" data-field="url">Description</th>
											<th title="Field #6" data-field="status" class="text-center">Status</th>
											<th title="Field #7" data-field="action" class="text-center">Action</th>
										</tr>
									</thead>
									<tbody>
                                                                            <%
                                                                                ...
                                                                                %>
										<tr>
                                                                                    <td><center><%= allContentPortalMasterObjectList.get(count)[0]%></center></td>
                                                                                        <td><center><%= allContentPortalMasterObjectList.get(count)[1]%></center></td>
											<td><%= allContentPortalMasterObjectList.get(count)[2]%></td>
                                                                                        <td><center><%= getStatus(allContentPortalMasterObjectList.get(count)[3], allContentPortalMasterObjectList.get(count)[0]) %><input type="hidden" value="<%= allContentPortalMasterObjectList.get(count)[3] %>" /></center></td>
											

                                                                                        
											<td><center><a href="edit_content_portal_master_details.htm?id=<%=allContentPortalMasterObjectList.get(count)[0]%>" class="ico edit">Edit</a></center></td>
										</tr>
                                                                                <%
                                                                                    }
                                                                                %>
