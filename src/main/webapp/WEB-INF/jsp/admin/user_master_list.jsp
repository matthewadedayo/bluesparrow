<%-- 
    Document   : user_master_list
    Created on : Jan 5, 2019, Jan 5, 2019 3:13:10 PM
    Author     : OLAWALE
--%>
...
<%!
    ...
    public String getButtonType(Object statuInt, Object id)
    {
        ...
        return Integer.parseInt(statuInt.toString()) == 1 ? "<button title=\"" + id + "\" type=\"button\" class=\"btn btn-success edit_user_master_status\">Active</button>" :  "<button  title=\"" + id + "\" type=\"button\" class=\"btn btn-danger edit_user_master_status\">Inactive</button>";
    }
%>
<% 
...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>BlueSparrow | List Users</title>
								...
								<div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
									<div class="row align-items-center">
										...
										<div class="col-xl-4 order-1 order-xl-2 m--align-right">
											<a href="mc_add_user.htm" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
												<span>
								...
								<table class="m-datatable" id="html_table" width="100%">
									<thead>
										<tr>
											...
											<th class="text-center" title="Field #2" data-field="UserType">User Type</th>
											<th class="text-center" title="Field #3" data-field="Company">Company</th>
											<th class="text-center" title="Field #4" data-field="FName">First Name</th>
											<th class="text-center" title="Field #5" data-field="LName">Last Name</th>
											<th class="text-center" title="Field #6" data-field="Designation">Designation</th>
											<th class="text-center" title="Field #7" data-field="Email">Email</th>
											<th class="text-center" title="Field #8" data-field="PhoneNumber">Phone Number</th>
											<th class="text-center" title="Field #9" data-field="Username">Username</th>
											<th class="text-center" title="Field #10" data-field="Password">Password</th>
											<th class="text-center" title="Field #11" data-field="status">Status</th>
											<th class="text-center" title="Field #12" data-field="Action">Action</th>
										</tr>
									</thead>
									<tbody>
                                                                            <%
                                  
                                    for(int count=0; count<userMasterObjectList.size();++count)
                                    {
                                  
                                  %>                
										<tr>
                                                                                    <td><center><%=userMasterObjectList.get(count)[0]%></center></td>
											<td><center><%=userMasterObjectList.get(count)[6]%></center></td>
											<td><center><%=userMasterObjectList.get(count)[7]%></center></td>
											<td><center><%=userMasterObjectList.get(count)[3]%></center></td>
											<td><center><%=userMasterObjectList.get(count)[4]%></center></td>
											<td><center><%=userMasterObjectList.get(count)[8]%></center></td>
											<td><center><%=userMasterObjectList.get(count)[9]%></center></td>
											<td><center><%=userMasterObjectList.get(count)[10]%></center></td>
											<td><center><%=userMasterObjectList.get(count)[1]%></center></td>
											<td><center><%=userMasterObjectList.get(count)[2]%></center></td>
											<td><center><%= getButtonType(userMasterObjectList.get(count)[5], userMasterObjectList.get(count)[0]) %><input type="hidden" value="<%=userMasterObjectList.get(count)[5]%>" class="status_hidden" /></center></td>
											<td><center><a href="edit_user_details.htm?id=<%=userMasterObjectList.get(count)[0]%>" class="ico edit">Edit</a></center></td>
										</tr>
                                                                                <%
                                    }
                                        %>
<!--										<tr>
											...
											<td>username2</td>
											<td>password2</td>
											<td><button type="button" class="btn btn-warning">Inactive</button></td>
