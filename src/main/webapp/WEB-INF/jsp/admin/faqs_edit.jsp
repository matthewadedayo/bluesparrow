<%-- 
    Document   : faqs_edit
    Created on : Mar 28, 2019, Mar 28, 2019 8:54:03 AM
    Author     : OLAWALE
--%>
...
//        HashMap<String, ArrayList<Object[]>> menuChildObjectMap = (HashMap<String, ArrayList<Object[]>>) session.getAttribute("menuChildObjectMap");
    ...
    Object[] faqsMasterObject = (Object[]) request.getAttribute("faqsMasterObject");
    ArrayList<Object[]> allContentPortalMasterObjectList = (ArrayList<Object[]>) request.getAttribute("allContentPortalMasterObjectList");
    ArrayList<Object[]> allFaqsPortalIdMappingObjectList = (ArrayList<Object[]>) request.getAttribute("allFaqsPortalIdMappingObjectList");
			...
			<div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-body">
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="faq_list.html" class="m-nav__link">
											<span class="btn btn-secondary m-btn m-btn--pill m-btn--wide btn-sm"><b>Faq list</b></span>
										</a>
									</li>
									<li class="m-nav__separator">-</li>
								</ul>
					...
					<div class="m-content">
						...
						<div class="m-portlet">
							<!--begin::Form-->
                                                        <form action="save_faqs_master.htm" class="m-form m-form--fit m-form--label-align-right" method="POST">
                                                            <input type="hidden" name="fm_id" value="<%=faqsMasterObject[0]%>" />
									...
									<div class="form-group m-form__group row">
										<label class="col-form-label col-lg-3 col-sm-12">
											...
											<select name="status" class="form-control">
                                                                                            <%
                                                                                                if(faqsMasterObject[6].toString().equals("0"))
                                                                                                {
                                                                                            %>
													...
													Draft
                                                                                            ...
                                                                                            <%
                                                                                                ...
                                                                                                else if(faqsMasterObject[6].toString().equals("1"))
                                                                                                {
                                                                                            %>
											...
											<select id="cont_visible" name="cont_visible" class="custom-select form-control">
                                                                                            <%
                                                                                                if(faqsMasterObject[3].toString().equals("PORTAL"))
                                                                                                {
                                                                                                    %>
                                                                                                    <option value="PORTAL" selected>
                                                                                                            Portal
                                                                                                    </option>
                                                                                                    <option value="CMS">
                                                                                                                CMS
											...
											<div class="m-form__group form-group">
																...
																<div class="m-checkbox-list">
																	...
																	<label class="m-checkbox">
                                                                                                                                            <input class="option_portal" type="checkbox" name="portal" value="<%= allContentPortalMasterObjectList.get(count)[0] %>" <% if(allFaqsPortalIdMappingObjectList!=null){ if(allFaqsPortalIdMappingObjectList.contains(allContentPortalMasterObjectList.get(count)[0])){%> checked <%}}%>>
										...
										<div class="col-lg-9 col-md-9 col-sm-12">
											<label for="exampleInputEmail1">
												Faq Title
                                                                                    ...
                                                                                    <input type="text" name="qtitle" class="form-control m-input m-input--square" id="exampleInputEmail1" value="<%= faqsMasterObject[1] %>" aria-describedby="emailHelp" placeholder="Your Question?">
											<span class="m-form__help">
												We are here to serve you better.
											</span>
											<div class="summernote ans_area" id="m_summernote_1"></div>
                                                                                        <input id="ans_id" type="hidden" name="answer" value="<%= faqsMasterObject[2] %>" />
										</div>
									</div>
									...
									<div class="m-form__actions m-form__actions">
										<div class="row">
											<div class="col-lg-9 ml-lg-auto">
												<button id="sub_faq_edit" type="submit" class="btn btn-brand">
													Submit
												</button>
...
<!-- begin::Footer -->
		...
		<script src="assets/demo/default/custom/components/forms/widgets/bootstrap-datetimepicker.js" type="text/javascript"></script>
                ...
                <script>
                    var portalOpt = $('#cont_visible').val();
                    if(portalOpt=='CMS')
                    {
                    ...
                    $('#m_summernote_1').text($('#ans_id').val()+"yes")
