...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>BlueSparrow | Content List</title>
		<meta name="description" content="Content List">
								...
								<div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
									<div class="row align-items-center">
										<div class="col-xl-8 order-2 order-xl-1">
                                                                                    <form id="load_by_title_frm" action="get_portal_by_cat_status.htm" method="get">
...
<!--																<option value="0">All</option>
												...
												<div class="col-md-4">
													<div class="m-form__group m-form__group--inline">
														...
														<div class="m-form__control">
                                                                                                                    <!--<form id="load_by_title_frm" action="get_portal_by_cat.htm" method="get">-->
...
<!--																<option value="1">Online</option>
										...
										<div class="col-xl-4 order-1 order-xl-2 m--align-right">
											<a href="mc_add_content_mster.htm" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
												<span>
								...
								<table class="m-datatable" id="" width="100%">
									<thead>
										<tr>
                                                                                    <th title="Field #1" class="text-center" data-field="ID">Record ID</th>
											<th title="Field #2" class="text-center" data-field="content_type">Content Type</th>
											<th title="Field #3" class="text-center" data-field="content_cat">Content Category</th>
											<th title="Field #4" class="text-center" data-field="content_sub_cat">Content Sub Category</th>
											<th title="Field #5" data-field="title">Title</th>
											<th title="Field #6" data-field="desc">Description</th>
											<th title="Field #7" class="text-center" data-field="user_rating">User Ratings</th>
											<th title="Field #8" class="text-center" data-field="user_rated">User Rated</th>
											<th title="Field #9" class="text-center" data-field="storage_type">Storage Type</th>
											<th title="Field #10" class="text-center" data-field="thumbnail_small">Thumbnail</th>
<!--											<th title="Field #11" data-field="thumbnail_mid">Thumbnail Mid</th>
											...
											<th title="Field #13" class="text-center" data-field="status">Status</th>
                                                                                        <th title="Field #14" class="text-center" data-field="action">Action</th>								
										</tr>
									</thead>
									<tbody>
                                                                            <%
...
<!--											<td><button type="button" class="btn-status btn-success">Published</button></td>-->
											...
											<!--<td><a href="#" class="ico edit"></a>Edit</td>-->
                                                                                        <td><center><%= getEditUrl2(allContentMasterObjectList.get(count)[12], allContentMasterObjectList.get(count)[0]) %><input type="hidden" name="remarks" class="hd_rmk" value="<%= allContentMasterObjectList.get(count)[13]%>"></center></td>
										</tr>
                                                                                <%
                                                                                    }
                                                                                %>
...
<!--										<tr>
											...
											<td>/content/20180515/Usagi_Yojimbo_400x400.jpg</td>
											<td>/content/20180515/Usagi_Yojimbo_600x600.jpg</td>											
											<td><button type="button" class="btn-status btn-warning">Pending</button></td>
											<td><a href="#" class="ico edit"></a>Edit</td>
										</tr>										
										<tr>
											<td>3</td>
											...
											<td>/content/20180515/Usagi_Yojimbo_400x400.jpg</td>
											<td>/content/20180515/Usagi_Yojimbo_600x600.jpg</td>											
											<td><button type="button" class="btn-status btn-danger">Disapproved</button></td>
											<td><a href="#" class="ico edit"></a>Edit</td>
										</tr>
										<tr>
											<td>1</td>
...
<!--										<button type="button" class="btn btn-primary">Save changes</button>-->
							...
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title" id="headerTitle">Full Description!</h5>
										<button type="button" class="close" data-dismiss="modal" aria-label="Close">
											<span aria-hidden="true">&times;</span>
										</button>
									</div>
