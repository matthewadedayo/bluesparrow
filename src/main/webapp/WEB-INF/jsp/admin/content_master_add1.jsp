<%-- 
    ...
    Created on : Nov 26, 2018, Nov 26, 2018 9:15:27 PM
    Author     : OLAWALE
--%>
											...
											<div class="m-wizard__head">
												...
												<!--begin: Form Wizard Progress -->
													...
													<div class="m--space-10"></div>
														<div class="progress">
															<div class="progress-bar bg-success" role="progressbar" style="width: 33%" aria-valuenow="50" aria-valuemin="" aria-valuemax="100"></div>
									...
									<form class="m-form m-form--fit m-form--label-align-right">
																...
																<div class="form-group m-form__group row">
																	...
																	<div class="col-xl-9 col-lg-9">
																		<select name="portal" class="form-control m-input">
												...
												<optgroup label="NON-FICTION">
													...
													<option value="WI">Sub-category-15</option>
																...
																<div class="form-group m-form__group row">
																	...
																	<div class="col-xl-9 col-lg-9">
																		<input type="text" name="name" class="form-control m-input" placeholder="Title" value="">
																...
																<div class="form-group m-form__group row">
																	...
																	<div class="col-xl-9 col-lg-9">
																		<textarea class="form-control m-input" id="" placeholder="Brief Description" rows="3"></textarea>
