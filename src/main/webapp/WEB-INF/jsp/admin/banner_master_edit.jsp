...
//    ArrayList<Object[]> menuMasterObjectList = (ArrayList<Object[]>) request.getAttribute("menuMasterObjectList");
      Object[] bannerMasterObject = (Object[]) request.getAttribute("bannerMasterObject");
...
//      Object userId = (Object)request.getAttribute("user_id");
      ...
      dimen.put("2", "1452x599");
      dimen.put("3", "270x407");
      dimen.put("4", "470x189");
      dimen.put("5", "370x189");
      dimen.put("6", "1920x1362");
...
<!--							<div>
					...
					<div class="m-content">
								...
								<div class="m-portlet m-portlet--tab m-portlet--center">
									...
									<!--begin::Form-->
                                                                        <form class="m-form m-form--fit m-form--label-align-right" action="save_banner_details.htm?id=<%= bannerMasterObject[0] %>" method="POST" enctype="multipart/form-data">
										...
										<div class="form-group m-form__group row">
											<div class="col-lg-12 m-form__group-sub">
													...
													<!--<option disabled selected value="">Select Portal</option>-->
                                                                                                        <%
                                                                                                                for(int i=0; i<allContentTypeMasterObjectList.size(); ++i)
                                                                                                                {
                                                                                                                    if(allContentTypeMasterObjectList.get(i)[0].toString().equals(bannerMasterObject[1].toString()))
                                                                                                                    {
                                                                                                                        %>
                                                                                                                        <option value="<%=allContentTypeMasterObjectList.get(i)[0]%>"><%=allContentTypeMasterObjectList.get(i)[1]%></option>
                                                                                                                        <%
                                                                                                                        break;
                                                                                                                    }
...
<!--													<option value="">Applications</option>
										...
										<div class="form-group m-form__group row">
												<div class="col-lg-12 m-form__group-sub">
													...
													<input type="text" name="title" class="form-control m-input" placeholder="Title" value="<%= bannerMasterObject[2] %>" required>
												</div>
										</div>
										...
										<div class="form-group m-form__group row">
											<div class="col-lg-12">
															...
															Banner Image*
                                                                                            ...
                                                                                            <input class="form-control m-input" id = "fileupload" name="banner_image" type = "file" required />
											</div>
										</div>
											...
											<div class="col-lg-12 m-form__group-sub">
												...
												<select name="size" class="form-control m-input" required>
													<%
                                                                                                                ...
                                                                                                                {
                                                                                                                    if(dimen.get(String.valueOf(i)).equals(bannerMasterObject[5].toString()))
                                                                                                                    {
                                                                                                                        %>
                                                                                                                        <option value="<%=dimen.get(String.valueOf(i))%>"><%=dimen.get(String.valueOf(i))%></option>
                                                                                                                        <%
                                                                                                                        break;
                                                                                                                    }
...
//                                                                                                                        break;
										...
										<div class="form-group m-form__group row">
												<div class="col-lg-12 m-form__group-sub">
													...
													<input type="text" name="url" class="form-control m-input" placeholder="Url" value="<%= bannerMasterObject[5] %>" required>
												</div>
										</div>
												...
												<div class="col-lg-12 m-form__group-sub">
													...
													<input type="text" name="dis_title" class="form-control m-input" placeholder="Display Title" value="<%= bannerMasterObject[9] %>">
												</div>
										</div>
                                                                                <div class="form-group m-form__group row">
												<div class="col-lg-12 m-form__group-sub">
															...
															Display Description
                                                                                                        ...
                                                                                                        <textarea class="form-control m-input" id="desc" placeholder="Brief Description" rows="3" name="dis_desc" maxlength="246"><%= bannerMasterObject[10] %></textarea>
												</div>
										</div>
                                                                                <div class="form-group m-form__group row">
												<div class="col-lg-12 m-form__group-sub">
													...
													<input type="text" name="dis_amount" class="form-control m-input" placeholder="Display Amount" value="<%= bannerMasterObject[11] %>">
												</div>
										</div>
                                                                                <div class="form-group m-form__group row">
												<div class="col-lg-12 m-form__group-sub">
													...
													<input type="text" name="dis_disc_percentage" class="form-control m-input" placeholder="Display Discount Percentage" value="<%= bannerMasterObject[12] %>">
												</div>
										</div>
															...
															Start Date*
                                                                                        ...
                                                                                        <input id="datepicker" name="start_date" class="form-control m-input" placeholder="Start on" value="<%= bannerMasterObject[7] %>" required>
												...
												<div class="col-lg-12 m-form__group-sub">
													...
													<input id="datepicker1" name="end_date" class="form-control m-input" placeholder="Expire on" value="<%= bannerMasterObject[8] %>" required>
