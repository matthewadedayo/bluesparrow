...
//      ArrayList<Object[]> userMasterObjectList = (ArrayList<Object[]>) request.getAttribute("userMasterObjectList");
        ArrayList<Object[]> allFaqsMasterObjectList = (ArrayList<Object[]>) request.getAttribute("allFaqsMasterObjectList");
...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>BlueSparrow | Faq List</title>
					...
					<div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-dark m-aside-menu--submenu-skin-dark " m-menu-vertical="1" m-menu-scrollable="1" m-menu-dropdown-timeout="500" style="position: relative;">
						<ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
							...
							<li class="m-menu__item  m-menu__item--submenu m-menu__item--open m-menu__item--expanded" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="#" class="m-menu__link m-menu__toggle"><i class="m-menu__link-icon flaticon-interface-9"></i><span class="m-menu__link-text">FAQS</span><i class="m-menu__ver-arrow la la-angle-right"></i></a>
                                      <div class="m-menu__submenu "><span class="m-menu__arrow"></span>
												<ul class="m-menu__subnav">
													<li class="m-menu__item m-menu__item--active" aria-haspopup="true"><a href="faq_list.html" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Faqs</span></a></li>
						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="faq_add.html" class="m-nav__link">   
											<span class="btn btn-secondary m-btn m-btn--pill m-btn--wide btn-sm"><b>Add New</b></span>
										</a>
									</li>
									<li class="m-nav__separator">-</li>
								</ul>
								...
								<table class="m-datatable" width="100%">
									<thead>
										<tr>
											...
											<th title="Field #2" data-field="Question">Question</th>
											<th title="Field #3" data-field="Answer">Answer</th>
											<th title="Field #4" data-field="date">Date</th>
											<th title="Field #5" data-field="portal">Portal</th>
											<th title="Field #6" data-field="status">Status</th>
                                                                                        <th title="Field #7" data-field="Action">Action</th>
										</tr>
									</thead>
									<tbody>
                                                                            <%
                                                                                for(int count=0; count<allFaqsMasterObjectList.size(); ++count)
                                                                                {

                                                                                %>
										<tr>
											<td style="text-align: center"><center><%= allFaqsMasterObjectList.get(count)[0]%></center></td>
											<td><center><%= allFaqsMasterObjectList.get(count)[1]%></center></td>
											<td><center><%= allFaqsMasterObjectList.get(count)[2]%></center></td>
                                                                                    <td><center><%= allFaqsMasterObjectList.get(count)[5]%></center></td>
                                                                                       <td ><center><%= allFaqsMasterObjectList.get(count)[3]%></center></td>
											<td><center><%= getStatus(allFaqsMasterObjectList.get(count)[6], allFaqsMasterObjectList.get(count)[0])%></center></td>
                                                                                        <td><center><a href="edit_faqs_details.htm?id=<%=allFaqsMasterObjectList.get(count)[0]%>" class="ico edit">Edit</a></center></td>
										</tr>
                                                                                <%
                                                                                    }
                                                                                %>
