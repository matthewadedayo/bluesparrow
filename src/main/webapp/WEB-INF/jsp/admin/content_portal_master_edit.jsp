...
//    ArrayList<Object[]> menuMasterObjectList = (ArrayList<Object[]>) request.getAttribute("menuMasterObjectList");
      Object[] contentPortalMasterObject = (Object[]) request.getAttribute("contentPortalMasterObject");
...
//      Map<String, String> dimen = new HashMap<String, String>();
//      dimen.put("0", "1920x250");
//      dimen.put("1", "1920x750");
...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>BlueSparrow | Add Portal</title>
		<meta name="description" content="Add Portal">
...
<!--							<div>
					...
					<div class="m-content">
								...
								<div class="m-portlet m-portlet--tab m-portlet--center">
									...
									<!--begin::Form-->
                                                                        <form class="m-form m-form--fit m-form--label-align-right" action="save_content_portal_master_details.htm?id=<%= contentPortalMasterObject[0] %>" method="POST" enctype="multipart/form-data">
										<div class="m-portlet__body">
										
														
										<div class="form-group m-form__group row">
												<div class="col-lg-12 m-form__group-sub">
													<input type="text" name="title" class="form-control m-input" placeholder="Title" value="<%= contentPortalMasterObject[1] %>">
												</div>
										</div>
										
										<div class="form-group m-form__group row">
											<div class="col-lg-12">
                                                                                            <textarea class="form-control m-input" id="desc" placeholder="Brief Description" rows="3" name="desc" required><%= contentPortalMasterObject[2] %></textarea>
											</div>
										</div>
