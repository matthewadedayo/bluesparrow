<%-- 
    Document   : content_file_add
    Created on : Nov 20, 2018, Nov 20, 2018 7:06:00 AM
    Author     : OLAWALE
--%>
...
//      ArrayList<Object[]> allContentTypeMasterObjectList = (ArrayList<Object[]>) request.getAttribute("allContentTypeMasterObjectList");
      ArrayList<Object[]> allContentFileObjectList = (ArrayList<Object[]>) request.getAttribute("allContentFileObjectList");
//      Object[] contentMasterObject = (Object[]) request.getAttribute("contentMasterObject");
      
      
              
              
//      Object[] contentMasterIdName = (Object[]) request.getAttribute("contentMasterIdName");
      
//      String contentMasterId = (String) request.getAttribute("contentMasterId");
//      
//      String contentTypeMasterTitle = (String) request.getAttribute("contentTypeMasterTitle");
//      String contentCategoryMasterTitle = (String) request.getAttribute("contentCategoryMasterTitle");
//      String contentSubCategoryMasterTitle = (String) request.getAttribute("contentSubCategoryMasterTitle");
//      String contentMasterTitle = (String) request.getAttribute("contentMasterTitle");
//      Object[] contentMasterIdName = (Object[]) request.getAttribute("contentMasterIdName");
...
//      String contentMasterType = (String) request.getAttribute("contentMasterType");
...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>BlueSparrow | Edit content</title>
						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="" class="m-nav__link">
											<span class="m-nav__link-text">Edit Content</span>
										</a>
									</li>
									<li class="m-nav__separator">-</li>
								</ul>
...
<!--							<div>
					...
					<div class="m-content">
											...
											<div class="m-wizard__head">
												...
												<!--begin: Form Wizard Progress -->
													...
													<div class="m--space-10"></div>
														<div class="progress">
															<div class="progress-bar bg-success" role="progressbar" style="width: 66%" aria-valuenow="50" aria-valuemin="" aria-valuemax="100"></div>
						...
						-->
									<!--begin::Form-->
									<form class="m-form m-form--fit m-form--label-align-right"  method="post" enctype="multipart/form-data" action="save_content_files_details.htm?id=<%= contentMasterDisplay[0] %>">
                                                                            
																<div class="m-form__heading">
																	<h3 class="m-form__heading-title">Edit Content File</h3>
																</div>

                                                                                                                                <div class="form-group m-form__group row">
																	<div class="col-lg-12">
																		<label class="form-control-label">* Content Type:</label>
                                                                                                                                                <input type="text" class="form-control m-input" placeholder="Title" value="<%=contentMasterDisplay[2] %>" name="type" id="" disabled>
																	...
																	<div class="col-lg-12">
																		<label class="form-control-label">* Content Category:</label>
                                                                                                                                                <input type="text" class="form-control m-input" placeholder="" value="<%=contentMasterDisplay[3]%>" name="" id="" disabled>
																	...
																	<div class="col-lg-12">
																		<label class="form-control-label">* Content Sub-Category:</label>
                                                                                                                                                <input type="text" class="form-control m-input" placeholder="" value="<%=contentMasterDisplay[4] %>" name="" id="" disabled>
																...
																<div class="form-group m-form__group row">
																	<div class="col-lg-12">
																		...
																		<input class="form-control m-input" id = "fileupload" type = "file" required name="file"  />
																		<span class="m-form__help">Please enter your preferred URL  to your dashboard</span>
																	</div>
																</div>

																<div class="form-group m-form__group row" style="display: <% if( contentMasterDisplay[2].toString().equalsIgnoreCase("GAME") || contentMasterDisplay[2].toString().equalsIgnoreCase("APPLICATION")){%> <%}else{ %> none <%}%>">
																	<div class="col-lg-12">
																		<label class="form-control-label">* Dimensions:</label>
																		<input type="text" name="width_height" class="form-control m-input" placeholder="e.g 400x600" value="" <% if( contentMasterDisplay[2].toString().equalsIgnoreCase("GAME") || contentMasterDisplay[2].toString().equalsIgnoreCase("APPLICATION")){%> required <%}else{ %> <%}%>>
																...
																<div class="form-group m-form__group row" style="display: <% if( contentMasterDisplay[2].toString().equalsIgnoreCase("GAME") || contentMasterDisplay[2].toString().equalsIgnoreCase("APPLICATION")){%> <%}else{ %> none <%}%>">
																	<div class="col-lg-6 m-form__group-sub">
																		...
																		<select name="os_name" class="form-control m-input" <% if( contentMasterDisplay[2].toString().equalsIgnoreCase("GAME") || contentMasterDisplay[2].toString().equalsIgnoreCase("APPLICATION")){%> required <%}else{ %> <%}%>>
																	...
																	<div class="col-lg-6 m-form__group-sub">
																		...
																		<input type="text" name="os_version" class="form-control m-input" placeholder="e.g. 5.0" value="" pattern="[0-9].[0-9]{1,3}" <% if( contentMasterDisplay[2].toString().equalsIgnoreCase("GAME") || contentMasterDisplay[2].toString().equalsIgnoreCase("APPLICATION")){%> required <%}else{ %> <%}%>>
														...
														<div class="m-form__actions">
															<div class="row">
																<div class="col-lg-6 m--align-left">
																	<a href="edit_content_master_details.htm?id=<%= contentMasterDisplay[0] %>" class="btn btn-secondary m-btn m-btn--custom m-btn--icon" >
																		<span>
...
<!--																	<a href="#" class="btn btn-primary m-btn m-btn--custom m-btn--icon" >-->
                                                                                                                                        <input type="submit" value="Submit" class="btn btn-primary m-btn m-btn--custom m-btn--icon" />
<!--																		<span>
...
<!--																			<i class="la la-check"></i>-->
																	...
																	<!--</a>-->
																	<a href="#" class="btn btn-success m-btn m-btn--custom m-btn--icon btn btn-focus" >
																		<span>
			
																			<span id="cont_btn">Continue</span>
							...
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content">
									...
									<div class="modal-body">
										<h5 id="msg_dia">Are you sure you want to continue?</h5>
									</div>
									<div class="modal-footer">
										<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
<!--										<button type="button" class="btn btn-primary">Save changes</button>-->

                                                                                <a id="save_cont" href="edit_content_meta_details.htm?content_master_id=<%= contentMasterDisplay[0] %>&content_master_title=<%=contentMasterDisplay[1]%>&content_type_title=<%=contentMasterDisplay[2] %>&content_cat_title=<%=contentMasterDisplay[3] %>&content_sub_cat_title=<%=contentMasterDisplay[4] %>" class="btn btn-primary">Save changes</a>
									</div>
								</div>
							</div>
						</div>
																					...
																					<table class="table table-bordered">
																						<thead>
																							<tr>
																								...
																								<th>File</th>
																								<!--<th>Metadata</th>-->
																								<th class="text-center">Width Height</th>
																						...
																						<tbody>
                                                                                                                                                                                    <%
                                                                                                                                                                                        for(int count=0; count<allContentFileObjectList.size(); ++count)
                                                                                                                                                                                        {

                                                                                                                                                                                        %>
																							<tr>
																								<th scope="row"><center><%= allContentFileObjectList.get(count)[0]%></center></th>
<!--																								<td></td>
																								<td></td>
																								<td></td>
																								<td></td>-->
																								<td><%= allContentFileObjectList.get(count)[2].toString().substring(allContentFileObjectList.get(count)[2].toString().lastIndexOf("."))%></td>
																								<!--<td>Metadata</td>-->
																								<td><center><%= allContentFileObjectList.get(count)[3]%></center></td>
																								<td><center><%= allContentFileObjectList.get(count)[4]%></center></td>
																								<td><center><%= allContentFileObjectList.get(count)[5]%></center></td>
																								<!--<td><button type="button" class="btn-status btn-primary">Pending</button></td>-->
																								<!--<td><a href="#" class="ico edit"></a> Delete</td>-->
                                                                                                                                                                                                <td><center><input type="button" class="btn btn-danger edit_content_file_status" value="Delete" title="<%= allContentFileObjectList.get(count)[0]%>" /><input type="hidden" value="<%= allContentFileObjectList.get(count)[6]%>" class="status_hidden" /></center></td>
																							</tr>
                                                                                                                                                                                        <%
                                                                                                                                                                                            }
                                                                                                                                                                                        %>
