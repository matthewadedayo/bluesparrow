<%-- 
    Document   : content_sub-category_master
    Created on : Oct 31, 2018, Oct 31, 2018 3:58:50 PM
    Author     : OLAWALE
--%>
...
<%!
    ...
    public String getButtonType(Object statuInt, Object id)
    {
        
        return Integer.parseInt(statuInt.toString()) == 1 ? "<button title=\"" + id + "\" type=\"button\" class=\"btn btn-success edit_sub_category_master_status\">Active</button>" :  "<button  title=\"" + id + "\" type=\"button\" class=\"btn btn-danger edit_sub_category_master_status\">Inactive</button>";
    }
    ...
    public String getStatus1(Object statuInt)
    {
        return Integer.parseInt(statuInt.toString())==1?"Active":"Not Active";
    }
%>
<% 
...
//      System.out.println("user: " + user[0]);
        ...
        ArrayList<Object[]> allContentSubCategoryMasterObjectList = (ArrayList<Object[]>) request.getAttribute("allContentSubCategoryMasterObjectList");
...
//        ArrayList<Object[]> allContentCategoryMasterObjectList = (ArrayList<Object[]>) request.getAttribute("allContentCategoryMasterObjectList");
        ...
        Object contentCategoryMasterId = (Object) request.getAttribute("contentCategoryMasterId");
        System.out.println("id: " + contentTypeId);
        
        
        Map<String, String> catMaster = new HashMap<String, String>();
      int nextCat = 0;
      while(nextCat < allContentCategoryMasterObjectList.size())
      {
          System.out.println("tp: " + allContentCategoryMasterObjectList.get(nextCat)[1].toString());
          catMaster.put(allContentCategoryMasterObjectList.get(nextCat)[0].toString(), allContentCategoryMasterObjectList.get(nextCat)[1].toString());
          nextCat++;
      }
...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>BlueSparrow | Content Category</title>
		<meta name="description" content="Content Category">
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title m-subheader__title--separator">Content Sub Category</h3>
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="" class="m-nav__link">
											<span class="m-nav__link-text">Add Sub Content Category</span>
										</a>
									</li>
...
<!--							<div>
					...
					<div class="m-content">
														<!--begin::Portlet-->
								<div class="m-portlet m-portlet--tab m-portlet m-portlet--center">
									...
									<!--begin::Form-->
									<form class="m-form m-form--fit m-form--label-align-right" action="add_content_sub_cat_mst.htm" method="post">
												...
												<div class="form-group m-form__group row">							
													...
													<label class="form-control-label">
															Content Type*
                                                                                                            ...
                                                                                                            <select id="cont_type" name="" class="form-control m-input" required>
												...
												<div class="form-group m-form__group row">	
													...
													<label class="form-control-label">
															Category Title*
                                                                                                            ...
                                                                                                            <div id="update">
                                                                                                            <select id="cont_cat" name="cont_cat_id" class="form-control m-input" required>
...
<!--															<option value="">Action</option>
												...
												<div class="form-group m-form__group row">
													...
													<input type="text" name="title" class="form-control m-input" placeholder="Enter Title" value="" required>
														<span class="m-form__help">
															Please enter your Sub Category title
														</span>
													</div>
													<div class="col-lg-6 m-form__group-sub">
														<label class="form-control-label">
															Sub Category Local Title*
														</label>
													<input type="text" name="local_title" class="form-control m-input" placeholder="Local Title" value="" required>
														<span class="m-form__help">
															Please enter your local Sub Category title
														</span>
													</div>
												</div>
										</div>
								...
								<div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
									<div class="row align-items-center">
										<div class="col-xl-8 order-2 order-xl-1">
                                                                                    <form id="load_by_title_frm" action="get_sub_cat_by_cat_stat.htm" method="get">
												...
												<div class="col-md-4">
													<div class="m-form__group m-form__group--inline">
														...
														<div class="m-form__control">
															<select class="form-control m-bootstrap-select sch_by" id="m_form_status" name="type">
...
<!--																<option value="1">Pending</option>
												...
												<div class="col-md-4">
													<div class="m-form__group m-form__group--inline">
														...
														<div class="m-form__control">
															<select class="form-control m-bootstrap-select sch_by" id="m_form_type" name="cat">
																<%
                                                                                                                                    
                                                                                                                                    if(contentCategoryMasterId==null)
                                                                                                                                    {
                                                                                                                                        %>
                                                                                                                                        <option value="0">All</option>
                                                                                                                                        <%
                                                                                                                                        ...
                                                                                                                                        %>
                                                                                                                                        <option value="<%=allContentCategoryMasterObjectList.get(count)[0]%>"><%=allContentCategoryMasterObjectList.get(count)[1]%></option>
                                                                                                                                        <%
                                                                                                                                        }
                                                                                                                                    }
                                                                                                                                    else
                                                                                                                                    {
                                                                                                                                        ...
                                                                                                                                        for(int i=0; i<catMaster.size(); ++i)
                                                                                                                                        {
                                                                                                                                            if(catMaster.containsKey(contentCategoryMasterId.toString()))
                                                                                                                                            {
                                                                                                                                                %>
                                                                                                                                                <option value="<%=contentCategoryMasterId%>"><%=catMaster.get(contentCategoryMasterId.toString())%></option>
                                                                                                                                                <%
                                                                                                                                                break;
                                                                                                                                            }
                                                                                                                                        ...
                                                                                                                                        <option value="0">All</option>
                                                                                                                                        <%
                                                                                                                                        Set<String> keys = catMaster.keySet();
                                                                                                                                        Iterator<String> itr = keys.iterator();
                                                                                                                                        ...
                                                                                                                                        while(itr.hasNext())
                                                                                                                                        {
                                                                                                                                            String key = itr.next();
//                                                                                                                                            if(!key.equals(allContentTypeMasterObjectList.get(i)[0].toString()) && !key.equals(contentTypeId.toString()))
                                                                                                                                            if(!key.equals(contentCategoryMasterId.toString()))
                                                                                                                                            {
                                                                                                                                                System.out.println(key + ":" + catMaster.get(key));
                                                                                                                                                 %>
                                                                                                                                                <option value="<%=key%>"><%=catMaster.get(key)%></option>
                                                                                                                                                <%
                                                                                                                                                ++i;
                                                                                                                                            }
                                                                                                                                        }
								...
								<table class="m-datatable" id="html_table" width="100%">
									<thead>
										<tr>
											...
											<th class="text-center" title="Field #2" data-field="portal">Content Type</th>
											<th title="Field #3" data-field="cat_title">Category Title</th>
											<th title="Field #4" data-field="cat_title_local">Category Local Title</th>
											<th title="Field #5" data-field="sub_cat_title">Sub Category Title</th>
											<th title="Field #6" data-field="sub_cat_title_local">Sub Category Title Local</th>
											<th class="text-center" title="Field #7" data-field="status">Status</th>
											<th class="text-center" title="Field #8" data-field="action">Action</th>
										</tr>
									</thead>
									<tbody>
                                                                            <%
                                                                            for(int count=0; count<allContentSubCategoryMasterObjectList.size(); ++count)
                                                                            {

                                                                            %>
										<tr>
                                                                                    
                                                                                    <td><center><%= allContentSubCategoryMasterObjectList.get(count)[0]%></center></td>
                                                                <td><center><%= allContentSubCategoryMasterObjectList.get(count)[1]%></center></td>
											<td><%= allContentSubCategoryMasterObjectList.get(count)[2]%></td>
											<td><%= allContentSubCategoryMasterObjectList.get(count)[3]%></td>
											<td><%= allContentSubCategoryMasterObjectList.get(count)[4]%></td>
											<td><%= allContentSubCategoryMasterObjectList.get(count)[5]%></td>
                                                                                        <td><center><%= getButtonType(allContentSubCategoryMasterObjectList.get(count)[6], allContentSubCategoryMasterObjectList.get(count)[0]) %><input type="hidden" value="<%=allContentSubCategoryMasterObjectList.get(count)[6]%>" class="status_hidden" /></center></td>
											<!--<td><button type="button" class="btn btn-success edit_sub_category_master_status">Active</button></td>-->
                                                                                        <td><center><a href="edit_content_sub_cat_mst_details.htm?id=<%=allContentSubCategoryMasterObjectList.get(count)[0]%>" class="ico edit">Edit</a></center></td>
										</tr>
                                                                                <%
                                                                            }
                                                                            %>
<!--										<tr>
											...
											<td>Non Fiction</td>
											<td>Non-Fiction EBook/Audiobook</td>
											<td>Education</td>
											<td>Education Non-Fiction</td>
