			...
			<div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-body">
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="subscription_list.html" class="m-nav__link">
											<span class="btn btn-secondary m-btn m-btn--pill m-btn--wide btn-sm"><b>Subscription List</b></span>
										</a>
									</li>
									<li class="m-nav__separator">-</li>
								</ul>
					...
					<div class="m-content">
						...
						<div class="m-portlet">
							<!--begin::Form-->
                                                        <form class="m-form m-form--fit m-form--label-align-right" action="save_sub.htm" method="POST">
                                                            <input type="hidden" name="sub_id" id="sub_id" value="<%=subscriptionMasterObject[0]%>" />
									  ...
									  <div class="col-lg-12 col-md-12 col-sm-12">
											<label for="exampleInputEmail1">
												Subscription
                                                                              ...
                                                                              <input type="text" name="sub_name" class="form-control m-input m-input--square" id="exampleInputEmail1" value="<%=subscriptionMasterObject[1]%>" placeholder="Subscription Name">
										</div>
									   ...
									   <div class="alert alert-primary m--margin-top-10" role="alert">
											...
											Price
                                                                                    ...
                                                                                    <input type="text" name="sub_price" class="form-control m-input m-input--square" id="price"  value="<%=subscriptionMasterObject[4]%>" placeholder="Enter Price">
										  
												<div class="alert alert-primary m--margin-top-10">
													Select Package
														</div>
                                                                                    <select name="sub_package" class="form-control">
                                                                                        <% if(subscriptionMasterObject[3].toString().equalsIgnoreCase("DAILY"))
                                                                                        {
                                                                                            %>
												...
												<option value="ONE-OFF">
													One-Off
                                                                                        ...
                                                                                        %>
                                                                                        <% if(subscriptionMasterObject[3].toString().equalsIgnoreCase("WEEKLY"))
                                                                                        {
                                                                                            %>
												...
												<option value="ONE-OFF">
													One-Off
                                                                                        ...
                                                                                        %>
                                                                                        <% if(subscriptionMasterObject[3].toString().equalsIgnoreCase("MONTHLY"))
                                                                                        {
                                                                                            %>
												...
												<option value="ONE-OFF">
													One-Off
                                                                                        ...
                                                                                        %>
                                                                                        <% if(subscriptionMasterObject[3].toString().equalsIgnoreCase("YEARLY"))
                                                                                        {
                                                                                            %>
												...
												<option value="ONE-OFF">
													One-Off
                                                                                        ...
                                                                                        %>
                                                                                        <% if(subscriptionMasterObject[3].toString().equalsIgnoreCase("ONE-OFF"))
                                                                                        {
                                                                                            %>
												...
												<option value="YEARLY">
													...
													Select Currency
                                                                                    ...
                                                                                    <select name="sub_currency" class="form-control">
												<option value="NGN">
													NGN
												</option>
											...
											<div class="m-form__group form-group">
																...
																<div class="m-radio-list">
                                                                                                                                    <%
                                                                                                                                        ...
                                                                                                                                        %>
																		<label class="m-radio">
																		<input type="radio" <% if(subscriptionMasterObject[2].toString().equalsIgnoreCase(allContentPortalMasterObjectList.get(count)[0].toString())){%> title="active" <%}%> class="portal_option<% if(subscriptionMasterObject[2].toString().equalsIgnoreCase(allContentPortalMasterObjectList.get(count)[0].toString())){%> active<%}%>" name="portal_id" value="<%= allContentPortalMasterObjectList.get(count)[0] %>" <%if(subscriptionMasterObject[2].toString().equalsIgnoreCase(allContentPortalMasterObjectList.get(count)[0].toString())){ %> checked <%}%>  >
