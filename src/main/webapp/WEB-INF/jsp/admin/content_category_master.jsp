<%-- 
    ...
    Created on : Oct 26, 2018, Oct 26, 2018 10:19:39 AM
    Author     : OLAWALE
--%>
...
<%!
    ...
    public String getButtonType(Object statuInt, Object id)
    {
        ...
        return Integer.parseInt(statuInt.toString()) == 1 ? "<button title=\"" + id + "\" type=\"button\" class=\"btn btn-success edit_category_master_status\">Active</button>" :  "<button  title=\"" + id + "\" type=\"button\" class=\"btn btn-danger edit_category_master_status\">Inactive</button>";
    }
    ...
    {
        return Integer.parseInt(statuInt.toString())==1?"Active":"Inactive";
    }
%>
<% 
...
<!--							<div>
					...
					<div class="m-content">
								...
								<div class="m-portlet m-portlet--tab m-portlet m-portlet--center">
									...
									<!--begin::Form-->
                                                                        <form class="m-form m-form--fit m-form--label-align-right" action="add_content_cat_mst.htm" method="post">
										<div class="m-portlet__body">
												<div class="form-group m-form__group row">							
													<div class="col-lg-12">
														...
														<select name="content_type_id" class="form-control m-input" required>
...
<!--															<option value="">Applications</option>
												...
												<!--<div class="form-group m-form__group row">
													...
													<input type="text" name="os" class="form-control m-input" placeholder="Enter Title" value="">
														<span class="m-form__help">
													...
													<input type="text" name="os-version" class="form-control m-input" placeholder="Local Title" value="">
														<span class="m-form__help">
									...
									<div class="row align-items-center">
										<div class="col-xl-8 order-2 order-xl-1">
											<div class="form-group m-form__group row align-items-center">
												...
												<div class="col-md-4">
                                                                                                    <form id="load_by_title_frm" action="get_content_cat.htm" method="GET">
													<div class="m-form__group m-form__group--inline">
														<div class="m-form__label">
															<label>Content Type:</label>
														</div>
														<div class="m-form__control">
                                                                                                                    <select class="form-control m-bootstrap-select sch_by" id="m_form_status" name="id">
																<%
...
//                                                                                                                                            if(!key.equals(allContentTypeMasterObjectList.get(i)[0].toString()) && !key.equals(contentTypeId.toString()))
												...
												<!--<div class="col-md-4">
													<div class="m-form__group m-form__group--inline">
														<div class="m-form__label">
															<label class="m-label m-label--single">Content Type:</label>
														</div>
														<div class="m-form__control">
								...
								<table class="m-datatable" id="html_table" width="100%">
									<thead>
										<tr>
											<th title="Field #1" data-field="ID" class="text-center">Record ID</th>
											<th title="Field #2" data-field="portal">ContentType</th>
									...
									<tbody>
                                                                          ...
                                                                          <tr>
                                                                              <td><center><%= allContentCategoryMasterObjectList.get(count)[0]%></center></td>
                                                                                <td><%= allContentCategoryMasterObjectList.get(count)[4]%></td>
                                                                                <td><%= allContentCategoryMasterObjectList.get(count)[1]%></td>
                                                                                <td><%= allContentCategoryMasterObjectList.get(count)[2]%></td>
                                                                                
                                                                                <td><center><%= getButtonType(allContentCategoryMasterObjectList.get(count)[3], allContentCategoryMasterObjectList.get(count)[0]) %><input type="hidden" value="<%=allContentCategoryMasterObjectList.get(count)[3]%>" class="status_hidden" /></center></td>

                                                                                
                                                                                <td><center><a href="edit_content_cat_mst_details.htm?id=<%=allContentCategoryMasterObjectList.get(count)[0]%>" class="ico edit edit_user" title="<%=allContentCategoryMasterObjectList.get(count)[0]%>">Edit</a></center></td>
