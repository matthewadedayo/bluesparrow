...
//        ArrayList<Object[]> allContentSubCategoryMasterObjectList = (ArrayList<Object[]>) request.getAttribute("allContentSubCategoryMasterObjectList");
        ...
        Object[] contentSubCategoryMasterObject = (Object[]) request.getAttribute("contentSubCategoryMasterObject");
...
<!--							<div>
					...
					<div class="m-content">
								...
								<div class="m-portlet m-portlet--tab m-portlet m-portlet--center">
									...
									<!--begin::Form-->
									<form class="m-form m-form--fit m-form--label-align-right" action="save_content_sub_cat_mst_details.htm?id=<%=contentSubCategoryMasterObject[0]%>" method="post">
												...
												<div class="form-group m-form__group row">							
													...
													<label class="form-control-label">
															Category Title*
                                                                                                            ...
                                                                                                            <input type="text" name="content_type_id" class="form-control m-input" placeholder="Enter Title" value="<%=contentSubCategoryMasterObject[1]%>" disabled>
<!--                                                                                                            <select id="cont_type" name="" class="form-control m-input">
												...
												<div class="form-group m-form__group row">	
													...
													<label class="form-control-label">
															Category Title*
                                                                                                            ...
                                                                                                            <input type="text" name="content_type_id" class="form-control m-input" placeholder="Enter Title" value="<%=contentSubCategoryMasterObject[2]%>" disabled>
<!--                                                                                                            <div id="update">
                                                                                                            <select id="cont_cat" name="cont_cat_id" class="form-control m-input">
												...
												<div class="form-group m-form__group row">
													...
													<input type="text" name="title" class="form-control m-input" placeholder="Enter Title" value="<%=contentSubCategoryMasterObject[4]%>" required>
													...
													<input type="text" name="local_title" class="form-control m-input" placeholder="Local Title" value="<%=contentSubCategoryMasterObject[5]%>" required>
														<span class="m-form__help">
